...
if (!["1.4.0", "1.5.0", "1.5.1", "1.5.2", "1.6.0", "1.7.3"].includes(packageJson.version)) throw new Error("Mega ZIP 5 requires version 1.4.0 or a supported cumulative version.");
...
if (!["5.0.0", "6.0.0", "9.0.0", "11.3.0"].includes(defaults.desktopContractVersion)) throw new Error("Desktop contract version must preserve Mega ZIP 5 or a supported cumulative contract.");
const required = [
