...
if (!["1.1.0", "1.2.0", "1.3.0", "1.4.0", "1.5.0", "1.5.1", "1.5.2", "1.6.0", "1.7.3"].includes(packageJson.version)) throw new Error("Mega ZIP 2 requires ANGELCARE Desktop version 1.1.0 or a supported cumulative version.")
