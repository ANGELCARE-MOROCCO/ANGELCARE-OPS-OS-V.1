...
if (!["1.1.0", "1.2.0", "1.3.0"].includes(packageJson.version)) throw new Error("Mega ZIP 2 requires ANGELCARE Desktop version 1.1.0 or a supported cumulative version.")
