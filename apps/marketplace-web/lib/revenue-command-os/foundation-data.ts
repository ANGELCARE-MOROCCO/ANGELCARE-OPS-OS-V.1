...
export function createFoundationBootstrap(
  ...
  return {
    ...
    operations: overrides.operations ?? {
      ...
      missions: [],
      channels: [
        { code: 'email_os', label: 'Email OS · mailboxes assignées', enabled: true, configured: false, userControllable: false, approvalRequired: false, policyState: 'active', reason: 'Canal Email OS disponible selon les mailboxes assignées.' },
        ...
        { code: 'whatsapp', label: 'WhatsApp', enabled: false, configured: false, userControllable: true, approvalRequired: false, policyState: 'available', reason: 'Activation manuelle disponible.' },
