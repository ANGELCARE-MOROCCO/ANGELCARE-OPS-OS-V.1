...
export interface CaseBuilderStage {
  label: string;
  status: 'Not Started' | 'AI Draft Ready' | 'Needs Data' | 'Needs Human Verification' | 'Needs Founder Approval'
  | 'Needs Finance Review' | 'Approved' | 'Final' | 'Blocked' | 'Rejected / Rework';
  readiness: number;
  owner: string;
  blockers: string;
  aiConfidence: number;
