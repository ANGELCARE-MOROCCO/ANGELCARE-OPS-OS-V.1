...
export function CommandFloorPage({ actor }: { actor: CapitalActor }) {
  ...
  async function generateBrief() {
    await action.execute(async () => postEnvelope("/api/ac-capital-os/reports/generate", { ...brief, sourceWorkspaces: ["capital-radar", "command-floor", "pipeline", "data-room", "approvals"], sections: ["Capital Situation", "Pipeline Exposure", "Founder Decisions", "Critical Proof", "Next 7 Days"] }), "Founder brief draft generated from the report API.");
  }
