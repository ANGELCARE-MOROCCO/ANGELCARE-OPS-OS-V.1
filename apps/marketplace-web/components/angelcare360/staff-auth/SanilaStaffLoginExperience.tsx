...
import styles from './SanilaStaffLoginExperience.module.css'
...
const REMEMBER_KEY = 'sanila.staff.login.identifier'
...
function LoginCard({ loginAction, loginError, safeNext }: Pick<Props, 'loginAction' | 'loginError' | 'safeNext'>) {
  ...
  return (
    <section className={styles.loginCard} aria-label="Connexion à l’espace Équipe SANILA">
      <div className={styles.staffBadge} aria-hidden="true"><UsersRound /></div>
      <div className={styles.cardHeading}>
        <h2>Espace Équipe</h2>
        <p>Connectez-vous pour accéder<br />à votre espace de collaboration.</p>
      </div>
      ...
      <form action={loginAction} className={styles.form} onSubmit={persistIdentifier}>
        ...
        {recoveryOpen ? (
          <div className={styles.recoveryNotice}>
            Utilisez le lien sécurisé transmis par votre établissement ou contactez votre administrateur pour réinitialiser votre accès.
          </div>
        ) : null}
...
export default function SanilaStaffLoginExperience(props: Props) {
  return (
    <main className={styles.page}>
      ...
      <section className={styles.stage}>
        <div className={styles.heroPanel}>
          <Image
            src="/sanila/staff-login/sanila-staff-morocco-approved.webp"
            alt="Équipe professionnelle marocaine collaborant dans un établissement scolaire"
            fill
            priority
        ...
        <div className={styles.authPanel}>
          <div className={styles.authInner}>
            ...
            <div className={styles.titleBlock}>
              <p>Pilotez vos tâches, demandes, documents, planning<br className={styles.desktopOnly} /> et opérations avec clarté et efficacité.</p>
            </div>
