...
import styles from './SanilaTeacherLoginExperience.module.css'
...
const REMEMBER_KEY = 'sanila.teacher.login.identifier'
  ...
  useEffect(() => {
    ...
    const refresh = async () => {
      ...
      try {
        ...
        // Authentication remains fully independent from the customer information channel.
      } finally {
...
function LoginCard({ loginAction, loginError, safeNext }: Pick<Props, 'loginAction' | 'loginError' | 'safeNext'>) {
  ...
  return (
    <section className={styles.loginCard} aria-label="Connexion à l’espace enseignant SANILA">
...
export default function SanilaTeacherLoginExperience(props: Props) {
  return (
    <main className={styles.page}>
      ...
      <section className={styles.stage}>
        <div className={styles.heroPanel}>
          <Image
            src="/sanila/teacher-login/sanila-teacher-morocco-approved.webp"
            alt="Enseignante marocaine dans un environnement scolaire professionnel"
            fill
            priority
        ...
        <div className={styles.authPanel}>
          <div className={styles.authInner}>
            ...
            <div className={styles.titleBlock}>
              ...
              <p>Gérez vos classes, présence, devoirs, évaluations<br className={styles.desktopOnly} /> et le suivi de chaque élève en toute simplicité.</p>
            </div>
