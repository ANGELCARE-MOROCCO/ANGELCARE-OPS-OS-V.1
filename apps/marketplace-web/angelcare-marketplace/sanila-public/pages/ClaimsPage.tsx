...
import { ClaimsResolutionLoop } from '../components/SanilaVisualSystems'
...
<section className={`${styles.section} ${styles.sectionSoft}`}><SectionHeading index="01" eyebrow="BOUCLE DE RÉSOLUTION" title="Un signalement devient utile quand il acquiert un responsable, une action et une trace."/><div className={styles.homeSystemStage}><ClaimsResolutionLoop/></div></section>
<section className={styles.section}><SectionHeading index="02" eyebrow="PROCESSUS" title="La confiance se récupère par une séquence lisible."/><ProcessSequence steps={page.workflow} variant="vertical"/></section>
<section className={`${styles.section} ${styles.sectionSoft}`}><div className={styles.domainSplit}><div className={styles.domainManifesto}>La qualité de la relation famille se mesure aussi à la façon dont l’établissement traite ce qui ne s’est pas bien passé.</div><EvidenceLedger sources={page.evidenceSources}/></div></section><ClosingStatement page={page}/></>}
