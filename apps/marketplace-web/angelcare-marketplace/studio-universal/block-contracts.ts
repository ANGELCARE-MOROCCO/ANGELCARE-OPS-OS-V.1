...
export const ANGELCARE_STUDIO_BLOCK_CONTRACTS: readonly StudioBlockContract[] = [
  ...
  contract('hero','Hero','content','Promesse, média et actions de conversion.',['eyebrow','title','lead','primaryCtaLabel','primaryCtaHref','secondaryCtaLabel','secondaryCtaHref','mediaAssetKey','mediaUrl','mediaAlt','sourceDesign'],'legacy',{requiresMedia:true}),
  contract('split_hero','Hero split','content','Hero éditorial image + copy.',['eyebrow','title','lead','primaryCtaLabel','primaryCtaHref','mediaAssetKey','mediaUrl','sourceDesign'],'legacy'),
  ...
  contract('cta_band','Bande CTA','conversion','Conversion vers une destination réelle.',['eyebrow','title','lead','primaryCtaLabel','primaryCtaHref','secondaryCtaLabel','secondaryCtaHref','sourceDesign'],'legacy'),
  contract('inquiry_form','Formulaire','conversion','Point d’entrée vers les workflows AngelCare approuvés.',['title','lead','sourceDesign'],'legacy'),
  ...
  contract('contact','Contact','conversion','Bloc contact.',['eyebrow','title','lead','primaryCtaLabel','primaryCtaHref','sourceDesign'],'legacy'),
  ...
  contract('studio_button','Bouton','conversion','Action vers une destination explicite.',['primaryCtaLabel','primaryCtaHref','sourceDesign'],'native'),
  ...
  contract('studio_form','Formulaire à relier','conversion','Structure de formulaire importée, destination neutralisée jusqu’à un workflow AngelCare approuvé.',['title','lead','items','sourceDesign'],'adapter',{requiresReview:true}),
