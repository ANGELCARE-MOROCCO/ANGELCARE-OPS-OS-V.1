...
export function validateConfiguration(configuration: WebPresenceConfiguration, _assets: WebPresenceMediaAsset[]): ValidationResult {
  ...
  return { valid: !issues.length, blockers: issues, warnings: [], checkedAt:new Date().toISOString() }
}
 ...
 */
export function validateConfigurationForPublication(_configuration: WebPresenceConfiguration, _assets: WebPresenceMediaAsset[]): ValidationResult {
