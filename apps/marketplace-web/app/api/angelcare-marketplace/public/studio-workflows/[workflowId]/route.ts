...
export async function POST(request:Request,{params}:{params:Promise<{workflowId:string}>}){
  ...
  try{
    ...
    const reference:StudioWorkflowSubmissionInput['reference']=body.reference&&typeof body.reference==='object'&&!Array.isArray(body.reference)?body.reference as StudioWorkflowSubmissionInput['reference']:{version:1,workflowId}
