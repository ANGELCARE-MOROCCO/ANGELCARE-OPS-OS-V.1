...
export default async function Page(){const c=await requireMarketplacePageContext('marketplace.security.view');return <AuthorityWorkspace eyebrow="GOVERNED CONTROL SURFACE" title="Security · Data Exposure" copy="Evidence, owner, status, expiry and action remain persistent and auditable." items={await listSecurityControls()}/>}
