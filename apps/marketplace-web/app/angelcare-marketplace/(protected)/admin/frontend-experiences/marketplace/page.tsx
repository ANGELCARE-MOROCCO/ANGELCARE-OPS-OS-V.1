...
export default async function Page(){await requireMarketplacePageContext('marketplace.commerce.view');const definition=SURFACE_BY_KEY.get('marketplace-index')!;const initial=await getFrontendSurface('marketplace-index');return initial?<SurfaceExperienceStudio definition={definition} initial={initial}/>:null}
