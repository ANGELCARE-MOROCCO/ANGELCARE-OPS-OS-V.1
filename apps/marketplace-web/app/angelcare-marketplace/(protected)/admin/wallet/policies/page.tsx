...
export default async function Page(){await requireMarketplacePageContext('marketplace.finance.price_books.manage');return <><WalletPolicyStudio initialPolicies={await adminWalletPolicies()}/><WalletPolicyImportStudio/></>}
