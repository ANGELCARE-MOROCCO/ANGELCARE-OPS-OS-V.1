...
export default async function Page(){const context=await requireMarketplacePageContext('marketplace.finance.view');return <AdminWalletCommand summary={await adminWalletCommand(context)}/>}
