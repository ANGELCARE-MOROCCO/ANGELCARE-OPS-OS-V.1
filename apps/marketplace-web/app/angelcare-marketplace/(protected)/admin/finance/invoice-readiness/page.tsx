...
export default async function Page(){const context=await requireMarketplacePageContext('marketplace.finance.view');return <InvoiceReadinessAuthority items={await listInvoiceReadiness(context)} canEvaluate={hasMarketplacePermission(context,'marketplace.finance.reconciliation.manage')}/>}
