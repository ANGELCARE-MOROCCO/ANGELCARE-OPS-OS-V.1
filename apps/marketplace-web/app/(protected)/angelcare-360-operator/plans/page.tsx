    ...
    >
        ...
        actions={[
          {
            ...
            fields: [
              ...
              { name: 'monthlyPriceMad', label: 'Prix mensuel (Dh)', kind: 'number', required: true },
              { name: 'annualPriceMad', label: 'Prix annuel (Dh)', kind: 'number', required: true },
      ...
      <Angelcare360OperatorDataTable
        ...
        columns={[
          ...
          { key: 'monthly_price_mad', label: 'Mensuel', align: 'right', render: (row) => `${Number((row as Record<string, unknown>).monthly_price_mad || 0).toLocaleString('fr-FR')} Dh` },
          { key: 'annual_price_mad', label: 'Annuel', align: 'right', render: (row) => `${Number((row as Record<string, unknown>).annual_price_mad || 0).toLocaleString('fr-FR')} Dh` },
