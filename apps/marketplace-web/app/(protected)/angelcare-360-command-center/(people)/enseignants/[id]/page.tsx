...
export default async function Angelcare360TeacherDetailPage({ params }: PageProps) {
  await requireAngelcare360RouteAccess('/angelcare-360-command-center/enseignants/[id]')
