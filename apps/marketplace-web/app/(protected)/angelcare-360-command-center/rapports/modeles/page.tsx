...
export default async function Angelcare360RapportsModelesAuthorityPage() {
  await requireAngelcare360RouteAccess('/angelcare-360-command-center/rapports/modeles')
