...
export default async function ReclamationsPrioritesPage(){
  await requireAngelcare360RouteAccess('/angelcare-360-command-center/reclamations/priorites');const snapshot=await getTrustResolutionSnapshot();return <TrustResolutionShell eyebrow="Priority Command" title="Priorités de résolution" description="Une vue de commandement par criticité réelle, responsabilité et retard — sans score artificiel ni analyse prédictive inventée."><TrustPriorityBoard snapshot={snapshot}/></TrustResolutionShell>}
