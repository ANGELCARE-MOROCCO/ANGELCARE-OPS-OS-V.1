...
export default async function PretDossierPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!dossier) notFound()
  return (
    <LibraryCommandShell schoolName={dossier.snapshot.schoolName} title="Circulation Chamber" subtitle="Emprunteur · exemplaire · échéance · retour · exceptions auditées">
