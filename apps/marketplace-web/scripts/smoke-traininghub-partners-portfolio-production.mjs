...
if (hardFailures.length) {
  console.error('Partners Portfolio production smoke FAILED: core tables unreachable.')
  process.exit(1)
}

console.log('TrainingHub Partners Portfolio production smoke PASSED with optional-table tolerance.')
