...
const file = path.join(root, "lib/service-os/execution-engine.ts");

if (!fs.existsSync(file)) {
  throw new Error("Missing lib/service-os/execution-engine.ts");
}

const content = `import { getServiceBlueprints, getServiceMissions } from "./engine"
...
console.log("patched lib/service-os/execution-engine.ts with normalized workflow engine");
