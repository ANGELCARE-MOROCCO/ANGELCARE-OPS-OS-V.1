...
add('official AngelCare white ribbon logo exists', () => exists('public/brand/angelcare-official-user-transparent.png'))
...
add('body uses official SANILA logo', () => client.includes('/brand/sanila-official-logo.png'))
add('top bar uses official AngelCare logo', () => client.includes('/brand/angelcare-official-user-transparent.png'))
