...
export const TEACHER_PORTAL_NAV: RolePortalNavItem[] = [
  ...
  { key:'teaching', label:'Enseignement', shortLabel:'Cours', href:'/angelcare-360-teacher/enseignement', description:'Cours, progression et continuité pédagogique publiés.', icon:'book' },
  ...
  { key:'families', label:'Relation familles', shortLabel:'Familles', href:'/angelcare-360-teacher/relation-familles', description:'Échanges traçables avec les responsables autorisés de vos élèves.', icon:'heart' },
...
export const PARENT_PORTAL_NAV: RolePortalNavItem[] = [
  ...
  { key:'finance', label:'Finance famille', shortLabel:'Finance', href:'/angelcare-360-parent/finance', description:'Factures, paiements, reçus, soldes et demandes adressées à l’établissement.', icon:'wallet' },
  { key:'transport', label:'Transport & sortie', shortLabel:'Transport', href:'/angelcare-360-parent/transport', description:'Transport, autorisations de sortie et demandes adressées à l’établissement.', icon:'bus' },
