...
export function createPeopleAuditConfig(): Angelcare360PeopleEntityConfig {
  return {
    ...
    subtitle: 'Suivi des opérations sensibles liées aux dossiers humains.',
    ...
    emptyDescription: 'Les opérations sensibles apparaîtront ici dès qu’elles seront enregistrées.',
    createLabel: 'Filtrer',
    editLabel: 'Détail',
    fields: [],
