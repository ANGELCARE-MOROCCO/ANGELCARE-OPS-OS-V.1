...
export const MODULE_ACCESS_LINKS = [
  ...
  { label: 'Revenue Command OS', href: '/revenue-command-os', permission: 'revenue_os.view', group: 'Revenue Command OS', icon: '🧠', badge: 'P1', order: 18 },
  { label: 'Revenue OS Objectives', href: '/revenue-command-os/revenue-objectives', permission: 'revenue_os.view', group: 'Revenue Command OS', icon: '🎯', order: 18.1 },
  { label: 'Revenue OS Audit', href: '/revenue-command-os/audit', permission: 'revenue_os.audit.view', group: 'Revenue Command OS', icon: '🧾', order: 18.2 },
