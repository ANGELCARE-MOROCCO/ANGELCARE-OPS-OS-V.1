...
export const MODULE_PERMISSIONS = {
  ...
  'revenue-command-center': [
    ...
    'revenue.tasks.read',
    'revenue.appointments.read',
    'revenue.partnerships.read',
    'revenue.b2c.read',
    'revenue.analytics.read',
    'revenue.activities.read',
  ],
...
export const MODULE_ACCESS_LINKS = [
  ...
  { label: 'Revenue Command OS', href: '/revenue-command-os', permission: 'revenue_os.view', group: 'Revenue Command OS', icon: '🧠', badge: 'P2', order: 18 },
  { label: 'Revenue Digital Twin', href: '/revenue-command-os/digital-twin', permission: 'revenue_os.view', group: 'Revenue Command OS', icon: '🧬', badge: 'P2', order: 18.1 },
  { label: 'Doctrine & mémoire', href: '/revenue-command-os/memory-learning', permission: 'revenue_os.view', group: 'Revenue Command OS', icon: '📚', badge: 'P3', order: 18.15 },
  { label: 'Revenue OS Signals', href: '/revenue-command-os/signals', permission: 'revenue_os.signals.manage', group: 'Revenue Command OS', icon: '📡', badge: 'P4', order: 18.16 },
  { label: 'Revenue OS Objectives', href: '/revenue-command-os/revenue-objectives', permission: 'revenue_os.view', group: 'Revenue Command OS', icon: '🎯', order: 18.2 },
  { label: 'Revenue OS Audit', href: '/revenue-command-os/audit', permission: 'revenue_os.audit.view', group: 'Revenue Command OS', icon: '🧾', order: 18.3 },
...
export const MODULE_ACCESS = [
  ...
  { key: 'revenue_os.digital_twin.manage', href: '/revenue-command-os/digital-twin' },
  { key: 'revenue_os.knowledge.manage', href: '/revenue-command-os/memory-learning' },
  { key: 'revenue_os.knowledge.approve', href: '/revenue-command-os/memory-learning/approval-desk' },
  { key: 'revenue_os.signals.manage', href: '/revenue-command-os/signals' },
  { key: 'revenue_os.signals.ingest', href: '/revenue-command-os/signals/source-control' },
  { key: 'revenue_os.signals.audit', href: '/revenue-command-os/signals/data-access' },
