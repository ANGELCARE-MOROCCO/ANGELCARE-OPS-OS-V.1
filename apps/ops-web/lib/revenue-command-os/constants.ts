...
export const REVENUE_OS_PERMISSIONS = {
  ...
  resourcesImport: 'revenue_os.resources.import',
  resourcesRun: 'revenue_os.resources.run',
...
export const REVENUE_OS_WORKSPACES: RevenueOsWorkspaceDefinition[] = [
  ...
  },
  {
    ...
    status: 'ready',
    accent: 'violet',
    contractScope: ['Modèles', 'Adaptateurs', 'Prompts', 'Outils', 'Schémas', 'Tests', 'Usage', 'Coûts', 'Runs', 'Audit'],
  },
  {
    key: 'strategy-engine',
