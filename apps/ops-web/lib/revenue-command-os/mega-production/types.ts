...
export type SystemMode='live'|'disabled'|'shadow'|'internal_only'|'draft_generation'|'approval_required'|'limited_autopilot'|'department_autonomy'|'suspended'|'emergency_stop'
