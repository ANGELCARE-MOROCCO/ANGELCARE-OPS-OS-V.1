...
export default async function Page(){ await requireHomeServiceAccess('homeservice_design.view'); const [catalogue,blueprints]=await Promise.all([loadFactoryCatalogue(),loadAllCategoryBlueprints()]); return <CategoryGatewayWorkspace catalogue={catalogue} blueprints={blueprints} initialMode="multi_mission"/> }
