...
export default async function AcademyDetailPage({ params }: { params: { id: string } }) {
 ...
 const path = '/academy/payments/' + params.id + '/edit'
 return <AppShell title="Payment Edit & Execute" subtitle="Deep Academy execution workspace" breadcrumbs={[{label:'Academy',href:'/academy'},{label:'Payments',href:'/academy/payments'},{label:String(title)}]} actions={<PageAction href="/academy/payments">Back</PageAction>}>
 <div style={page}>
