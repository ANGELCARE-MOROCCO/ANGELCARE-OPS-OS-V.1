...
export default async function AcademyDetailPage({ params }: { params: { id: string } }) {
 ...
 const path = '/academy/partners/' + params.id
 return <AppShell title="Partner Command Folder" subtitle="Deep Academy execution workspace" breadcrumbs={[{label:'Academy',href:'/academy'},{label:'Partners',href:'/academy/partners'},{label:String(title)}]} actions={<PageAction href="/academy/partners">Back</PageAction>}>
 <div style={page}>
