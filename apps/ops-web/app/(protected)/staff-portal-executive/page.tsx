...
export default async function Page() {
  ...
  return (
    <AppShell title="Staff Portal Executive" subtitle="Leadership-readable staff portal overview for signals, route density and execution pressure." breadcrumbs={[{ label: 'Staff Portal', href: '/staff-home' }, { label: 'Executive' }]} actions={<PageAction href="/staff-home" variant="light">Home</PageAction>}>
      <EnterprisePageShell>
        <EnterpriseHero eyebrow="Staff Portal OS Mega Phase 7" title="Staff Portal Executive" subtitle="Leadership-readable staff portal overview for signals, route density and execution pressure." tone="purple" stats={[
        ...
        <div style={{ height: 22 }} />
        <EnterprisePanel title="Command Zones" subtitle="Open the correct operating workspace." tone="purple">
