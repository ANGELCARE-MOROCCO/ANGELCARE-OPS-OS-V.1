            ...
            <div className={`flex items-center ${collapsed ? 'justify-center' : 'gap-3'}`}>
              ...
              {!collapsed ? (
                <div className="min-w-0">
                  <p className="truncate text-xs font-black text-slate-900">Phase 16 — Mega Production</p>
                  <p className="mt-0.5 truncate text-[11px] font-semibold text-slate-500">Learning OS · Production gouvernée</p>
                </div>
              ) : null}
            </div>
          </div>
