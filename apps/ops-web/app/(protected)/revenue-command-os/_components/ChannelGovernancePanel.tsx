...
export default function ChannelGovernancePanel({ initialPolicies }: { initialPolicies: RevenueOsChannelPolicy[] }) {
  ...
  const toggleWhatsapp = async () => {
    ...
    try {
      ...
      setNotice(!whatsapp.enabled ? 'WhatsApp activé. Le canal est immédiatement disponible selon sa configuration technique actuelle.' : 'WhatsApp désactivé pour Revenue OS.')
    } catch (cause) {
