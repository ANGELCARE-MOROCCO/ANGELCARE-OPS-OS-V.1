  ...
  return <div className={`${sovereigntyStyles.canvas} min-h-screen px-4 py-7 sm:px-7 lg:px-10 xl:px-12`}>
    <section className="mx-auto max-w-[1800px]">
      <div className="grid gap-6 xl:grid-cols-[1fr_430px] xl:items-end">
        <div>
          <div className="flex flex-wrap items-center gap-2"><SChip tone="navy"><Orbit size={12} /> Revenue Constellation</SChip><SChip tone="emerald">Production live</SChip><SChip tone="violet">Autorité complète</SChip></div>
