...
export default function RevenueCommandOsNotFound() {
  return (
    <div className="rounded-[30px] border border-slate-200 bg-white p-10 text-center shadow-[0_18px_60px_rgba(15,23,42,.06)]">
      ...
      <p className="mx-auto mt-3 max-w-lg text-sm leading-7 text-slate-500">Cette surface n’appartient pas au registre Revenue Command OS cumulatif Phase 2 ou a été appelée avec un identifiant invalide.</p>
