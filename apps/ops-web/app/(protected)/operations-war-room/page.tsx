...
export default function Page() {
  ...
  return (
    <AppShell title="Operations War Room" subtitle="Operational execution command" breadcrumbs={[{ label: 'OPS OS', href: '/enterprise-command' }, { label: 'Ops War Room' }]} actions={<PageAction href="/opsos-final-qa" variant="light">Final QA</PageAction>}>
      <GlobalShell>
        <GlobalNavStrip items={nav} />
        <GlobalHero
          eyebrow="AngelCare OPS OS Mega Pack V1"
          title="Operations War Room"
          subtitle="Daily operational execution layer for incidents, missions, staff pressure and command escalation."
          tone="red"
          stats={[
        ...
        <GlobalPanel title="Operations Execution Zones" subtitle="Field and internal operations command surfaces." tone="red">
          {OPSOS_MODULES.map((m) => (
