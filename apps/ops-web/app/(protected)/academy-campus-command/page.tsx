...
export default function Page() {
  ...
  return (
    <AppShell title="Academy Campus Command" subtitle="Training center operations" breadcrumbs={[{ label: 'OPS OS', href: '/enterprise-command' }, { label: 'Academy Campus' }]} actions={<PageAction href="/opsos-final-qa" variant="light">Final QA</PageAction>}>
      <GlobalShell>
        <GlobalNavStrip items={nav} />
        <GlobalHero
          eyebrow="AngelCare OPS OS Mega Pack V1"
          title="Academy Campus Command"
          subtitle="Training operations command layer for programs, cohorts, trainers, trainees and certifications."
          tone="cyan"
          stats={[
        ...
        <GlobalPanel title="Academy Execution Domains" subtitle="Campus, programs and training command surfaces." tone="cyan">
          {OPSOS_MODULES.map((m) => (
