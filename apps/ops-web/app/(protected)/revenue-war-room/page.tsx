...
export default function Page() {
  ...
  return (
    <AppShell title="Revenue War Room" subtitle="Sales and revenue execution" breadcrumbs={[{ label: 'OPS OS', href: '/enterprise-command' }, { label: 'Revenue War Room' }]} actions={<PageAction href="/opsos-final-qa" variant="light">Final QA</PageAction>}>
      <GlobalShell>
        <GlobalNavStrip items={nav} />
        <GlobalHero
          eyebrow="AngelCare OPS OS Mega Pack V1"
          title="Revenue War Room"
          subtitle="Commercial command layer for leads, appointments, contracts, pipeline and conversion pressure."
          tone="green"
          stats={[
        ...
        <GlobalPanel title="Revenue Execution Domains" subtitle="Pipeline, client and sales execution surfaces." tone="green">
          {OPSOS_MODULES.map((m) => (
