...
export default function Page() {
  ...
  return (
    <AppShell title="Module Specialization" subtitle="Specialized operating identities" breadcrumbs={[{ label: 'OPS OS', href: '/enterprise-command' }, { label: 'Module Specialization' }]} actions={<PageAction href="/opsos-final-qa" variant="light">Final QA</PageAction>}>
      <GlobalShell>
        <GlobalNavStrip items={nav} />
        <GlobalHero
          eyebrow="AngelCare OPS OS Mega Pack V1"
          title="Module Specialization Matrix"
          subtitle="Defines how each module should feel, operate and execute differently instead of sharing one generic dashboard."
          tone="cyan"
          stats={[
        ...
        <GlobalPanel title="Specialization Targets" subtitle="Module-by-module premium output direction." tone="cyan">
          {OPSOS_MODULES.map((m) => (
