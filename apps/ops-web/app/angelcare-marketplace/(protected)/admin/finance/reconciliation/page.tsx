...
export default async function Page(){const context=await requireMarketplacePageContext('marketplace.finance.view');return <ReconciliationAuthority items={await listReconciliation(context)}/>}