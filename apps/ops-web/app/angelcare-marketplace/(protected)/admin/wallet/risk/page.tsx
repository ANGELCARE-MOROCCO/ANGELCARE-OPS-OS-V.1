...
export default async function Page(){const context=await requireMarketplacePageContext('marketplace.security.manage');return <AdminWalletCommand summary={await adminWalletCommand(context)}/>}
