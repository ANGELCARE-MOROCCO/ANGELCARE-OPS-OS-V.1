...
async function GET__angelcareGovernedImpl(_request: NextRequest, context: RouteContext) {
...
export const GET = governRoute(
  {
    workloadClass: 'heavy',
    operation: 'GET:/api/academy/trainers/[id]/payments/[paymentId]/receipt/pdf',
  },
