...
async function syncCollectionCohortToTrainerAssignments(supabase: any, cohort: Record<string, any>) {
...
async function academyCohortsCollectionUpdate(request: Request) {
  ...
  if (body.training_start_time !== undefined) patch.training_start_time = body.training_start_time || '09:00'
  if (body.training_end_time !== undefined) patch.training_end_time = body.training_end_time || '17:00'
  ...
  await syncCollectionCohortToTrainerAssignments(supabase, data)
