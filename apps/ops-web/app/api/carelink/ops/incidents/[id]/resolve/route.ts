import { resolveOpsIncident } from '@/lib/carelink/ops-enterprise'
...
export async function POST(request: Request, context: Context) {
  try {
    ...
    const incident = await resolveOpsIncident({
      incidentId,
    ...
    return opsError(error, 'Impossible de résoudre l’incident Ops')
  }
}
