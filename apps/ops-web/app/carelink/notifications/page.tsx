...
export default async function CareLinkNotificationsPage() {
  const workspace = await loadCarelinkMobileWorkspaceOrRedirect()
  return <CareLinkFieldAgentPremiumApp records={workspace.records} workspace={workspace} view="notifications" />
}
