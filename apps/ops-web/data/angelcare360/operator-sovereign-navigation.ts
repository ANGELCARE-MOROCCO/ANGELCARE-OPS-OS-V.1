...
export const SOVEREIGN_TOWERS: SovereignTowerDefinition[] = [
  ...
  },
  {
    ...
    navigation: [
      { label: 'Revenue Command', href: '/angelcare-360-operator/revenue' },
      { label: 'Pricing', href: '/angelcare-360-operator/plans' },
      { label: 'Subscriptions', href: '/angelcare-360-operator/subscriptions' },
      { label: 'Contrats', href: '/angelcare-360-operator/contracts' },
      { label: 'Facturation', href: '/angelcare-360-operator/billing' },
      { label: 'Factures', href: '/angelcare-360-operator/billing/invoices' },
      { label: 'Paiements', href: '/angelcare-360-operator/billing/payments' },
      { label: 'Recouvrement', href: '/angelcare-360-operator/billing/dunning' },
      { label: 'Exposition', href: '/angelcare-360-operator/billing/balances' },
      { label: 'Prévisions', href: '/angelcare-360-operator/executive/revenue' },
    ],
  },
  {
    ...
    navigation: [
      { label: 'Service Command', href: '/angelcare-360-operator/service' },
      { label: 'Activation', href: '/angelcare-360-operator/onboarding' },
      { label: 'Implémentation', href: '/angelcare-360-operator/implementation' },
      { label: 'Adoption', href: '/angelcare-360-operator/service?view=adoption' },
      { label: 'Support', href: '/angelcare-360-operator/support' },
      { label: 'Demandes', href: '/angelcare-360-operator/service-requests' },
      { label: 'Incidents', href: '/angelcare-360-operator/incidents' },
      { label: 'Opérations', href: '/angelcare-360-operator/service-operations' },
      { label: 'Tâches', href: '/angelcare-360-operator/tasks' },
      { label: 'Notes', href: '/angelcare-360-operator/notes' },
    ],
  },
  {
    ...
    summary: 'Identités, autorités, sécurité, politiques, audit, automatisations, intégrations et santé plateforme.',
    signal: 'Autorité & confiance', accent: '#334155', accentDeep: '#0f172a',
    navigation: [
      { label: 'Control Lattice', href: '/angelcare-360-operator/platform' },
      { label: 'Identités', href: '/angelcare-360-operator/operator-roles' },
      { label: 'Autorités', href: '/angelcare-360-operator/platform?view=authority' },
      { label: 'Sécurité', href: '/angelcare-360-operator/platform?view=security' },
      { label: 'Politiques', href: '/angelcare-360-operator/settings' },
      { label: 'Audit', href: '/angelcare-360-operator/audit' },
      { label: 'Automatisations', href: '/angelcare-360-operator/platform?view=automation' },
      { label: 'Email Automation OS', href: '/angelcare-360-operator/email-command' },
      { label: 'Brand Governance', href: '/angelcare-360-operator/brand-governance' },
      { label: 'Intégrations', href: '/angelcare-360-operator/platform?view=integrations' },
      { label: 'Santé plateforme', href: '/angelcare-360-operator/platform?view=health' },
    ],
  },
]
