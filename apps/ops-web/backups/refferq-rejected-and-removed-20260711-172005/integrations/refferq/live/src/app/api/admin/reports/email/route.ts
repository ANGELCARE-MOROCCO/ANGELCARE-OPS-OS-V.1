...
import { resend } from '@refferq/lib/email';
    ...
    <body>
      ...
      <div class="content">
        ...
        <p style="margin-top: 20px;">
          <a href="${process.env.NEXT_PUBLIC_APP_URL}/market-os/ambassadors/refferq/admin/reports" style="display: inline-block; background: #667eea; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px;">
            View Full Report
          </a>
        </p>
      </div>
