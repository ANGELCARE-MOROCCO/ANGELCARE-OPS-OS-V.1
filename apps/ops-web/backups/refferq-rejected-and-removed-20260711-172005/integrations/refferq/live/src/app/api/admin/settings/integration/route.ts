...
// GET /api/market-os/refferq/admin/settings/integration - Get integration settings
export async function GET(req: NextRequest) {
  try {
    ...
    console.error('GET /api/market-os/refferq/admin/settings/integration error:', error);
    return NextResponse.json(
...
// POST /api/market-os/refferq/admin/settings/integration - Create or update integration settings
export async function POST(req: NextRequest) {
  try {
    ...
    console.error('POST /api/market-os/refferq/admin/settings/integration error:', error);
    return NextResponse.json(
...
// DELETE /api/market-os/refferq/admin/settings/integration - Delete integration settings
export async function DELETE(req: NextRequest) {
  try {
    ...
    console.error('DELETE /api/market-os/refferq/admin/settings/integration error:', error);
    return NextResponse.json(
