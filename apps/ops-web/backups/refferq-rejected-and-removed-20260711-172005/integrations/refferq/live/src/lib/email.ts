...
async function sendWithConfiguredTransport(payload: SendPayload): Promise<{ data: { id: string } | null; error: Error | null }> {
  const from = payload.from || process.env.RESEND_FROM_EMAIL || "Refferq <noreply@refferq.com>"
  ...
  if (!transport) {
    return {
      data: null,
      error: new Error("Email transport not configured"),
    }
  }
  ...
  try {
    ...
    return {
      data: null,
      error: error instanceof Error ? error : new Error("Email send failed"),
    }
  }
}
...
export const resend = {
  emails: {
    send: sendWithConfiguredTransport,
  },
}
...
class EmailService {
  ...
  private async sendEmail(params: {
    ...
    const result = await sendWithConfiguredTransport({
  ...
  private generateReferralNotificationHTML(data: ReferralNotificationData, _symbol?: string): string {
    ...
    <body>
      ...
      <div class="content">
        ...
        <div style="text-align: center;">
          <a href="${process.env.NEXT_PUBLIC_APP_URL}/market-os/ambassadors/refferq/admin" class="button">Review Referral</a>
        </div>
  ...
  private generateApprovalEmailHTML(data: ApprovalEmailData, _symbol?: string): string {
    ...
    <body>
      ...
      <div class="content">
        ...
        <div style="text-align: center;">
          <a href="${process.env.NEXT_PUBLIC_APP_URL}/market-os/ambassadors/refferq/affiliate" class="button">View Dashboard</a>
        </div>
  ...
  private generateConversionNotificationHTML(data: ConversionNotificationData, symbol: string): string {
    ...
    <body>
      ...
      <div class="content">
        ...
        <div style="text-align: center;">
          <a href="${process.env.NEXT_PUBLIC_APP_URL}/market-os/ambassadors/refferq/affiliate" class="button">View Your Dashboard</a>
        </div>
    ...
    return this.sendTemplatedEmail({
      ...
      <body>
        ...
        <div class="content">
          ...
          <div style="text-align: center;">
            <a href="${process.env.NEXT_PUBLIC_APP_URL}/market-os/ambassadors/refferq/affiliate" class="button">View Payout Status</a>
          </div>
  ...
  async sendCustomEmail(to: string, subject: string, html: string): Promise<{ success: boolean; message: string }> {
    ...
    console.log("Custom email sent:", result.data)
    return { success: true, message: "Email sent successfully" }
  }
