...
function AmbassadorSafeSidebarIcon({
  icon: Icon,
  className,
}: {
  icon?: any;
  ...
  const SafeIcon = typeof Icon === "function" ? Icon : LayoutDashboard;
            ...
            <div className="space-y-1">
              {group.items.map((item) => {
                ...
                return (
                  ...
                  >
                    <AmbassadorSafeSidebarIcon icon={Icon} className={active ? "text-violet-700" : "text-slate-9500"} size={16} />
