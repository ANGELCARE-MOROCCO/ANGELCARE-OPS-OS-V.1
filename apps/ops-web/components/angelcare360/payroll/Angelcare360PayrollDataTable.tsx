...
export type Angelcare360PayrollTableColumn<T> = {
  key: string
  label: string
...
type Angelcare360PayrollDataTableProps<T> = {
  title: string
  description?: string
  columns: Array<Angelcare360PayrollTableColumn<T>>
  rows: T[]
  emptyTitle: string
  emptyDescription: string
}

export default function Angelcare360PayrollDataTable<T>({
  title,
  description,
  columns,
  rows,
  emptyTitle,
  emptyDescription,
}: Angelcare360PayrollDataTableProps<T>) {
  return (
