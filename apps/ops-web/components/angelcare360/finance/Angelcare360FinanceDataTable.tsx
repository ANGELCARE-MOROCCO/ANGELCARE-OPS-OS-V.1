...
export type Angelcare360FinanceTableColumn<T> = {
  key: string
  label: string
...
type Angelcare360FinanceDataTableProps<T> = {
  title: string
  description?: string
  columns: Array<Angelcare360FinanceTableColumn<T>>
  rows: T[]
  emptyTitle: string
  emptyDescription: string
}

export default function Angelcare360FinanceDataTable<T>({
  title,
  description,
  columns,
  rows,
  emptyTitle,
  emptyDescription,
}: Angelcare360FinanceDataTableProps<T>) {
  return (
