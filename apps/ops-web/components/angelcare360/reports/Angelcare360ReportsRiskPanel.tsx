...
export default function Angelcare360ReportsRiskPanel({ risks }: Props) {
  return (
    <section style={panelStyle}>
      <div style={headerStyle}>
        <h2 style={titleStyle}>Risques de reporting</h2>
      ...
      {risks.length ? (
        ...
        <div style={okStyle}>Aucun risque de reporting majeur détecté.</div>
      )}
    </section>
  )
}
