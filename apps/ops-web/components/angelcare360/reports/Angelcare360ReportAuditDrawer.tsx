...
export default function Angelcare360ReportAuditDrawer({ events }: Props) {
  return (
    <section style={panelStyle}>
      <h2 style={titleStyle}>Audit rapports</h2>
      {events.length ? (
        ...
        <div style={emptyStyle}>Aucun événement d’audit rapports.</div>
      )}
    </section>
  )
}
