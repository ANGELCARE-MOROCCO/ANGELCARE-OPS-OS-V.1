...
export default function Angelcare360ClaimsNavigation({ items }: Props) {
  return (
    <nav style={navStyle}>
      {items.map((item) => (
...
const badgeStyle: React.CSSProperties = { display: 'inline-flex', width: 'fit-content', borderRadius: 999, padding: '4px 8px', background: '#fff7ed', color: '#c2410c', fontSize: 11, fontWeight: 900 }
