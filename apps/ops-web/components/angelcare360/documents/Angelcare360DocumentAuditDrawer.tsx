...
export default function Angelcare360DocumentAuditDrawer({ events }: Props) {
  return (
    <section style={panelStyle}>
      <h2 style={titleStyle}>Audit documents</h2>
      {events.length ? (
        ...
        <div style={emptyStyle}>Aucun événement d’audit documents.</div>
      )}
    </section>
  )
}
