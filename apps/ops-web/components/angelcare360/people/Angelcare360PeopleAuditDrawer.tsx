...
type Angelcare360PeopleAuditDrawerProps = {
  open: boolean
  event: Angelcare360AuditRecord | null
  onClose: () => void
}

export default function Angelcare360PeopleAuditDrawer({ open, event, onClose }: Angelcare360PeopleAuditDrawerProps) {
        ...
        <div style={headerStyle}>
          <div>
            ...
            <p style={subtitleStyle}>
              {event.entity_type || 'entité non précisée'} · {new Date(event.created_at).toLocaleString('fr-FR')}
            </p>
          </div>
        ...
        <div style={gridStyle}>
          <div style={cardStyle}>
            ...
            <div style={valueStyle}>
              {event.actor_role || '—'} · {event.actor_user_id || '—'}
            </div>
          </div>
          <div style={cardStyle}>
