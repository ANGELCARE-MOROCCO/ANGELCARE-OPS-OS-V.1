...
import type { Angelcare360PeopleFilterDefinition } from '@/types/angelcare360/people'

type Angelcare360PeopleToolbarProps = {
  search: string
  onSearchChange: (value: string) => void
  searchPlaceholder?: string
  filters?: Array<{
    definition: Angelcare360PeopleFilterDefinition
    value: string
  ...
  secondaryActionDisabledReason?: string
  onSecondaryAction?: () => void
  onReset?: () => void
  extraActions?: ReactNode
}

export default function Angelcare360PeopleToolbar({
  search,
  onSearchChange,
  searchPlaceholder,
  filters = [],
  ...
  secondaryActionDisabledReason,
  onSecondaryAction,
  onReset,
  extraActions,
}: Angelcare360PeopleToolbarProps) {
  return (
      ...
      <div style={searchRowStyle}>
        <label style={labelStyle}>
          ...
          <input
            ...
            placeholder={searchPlaceholder || 'Rechercher par nom, code, classe, parent ou statut'}
            style={inputStyle}
          />
        </label>
        ...
        {secondaryActionLabel ? (
          <button
            ...
            disabled={!onSecondaryAction || Boolean(secondaryActionDisabledReason)}
            title={secondaryActionDisabledReason}
            style={!onSecondaryAction || secondaryActionDisabledReason ? disabledButtonStyle : ghostButtonStyle}
          >
            {secondaryActionLabel}
          </button>
        ) : null}
