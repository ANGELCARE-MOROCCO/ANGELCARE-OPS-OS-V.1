      ...
      <section className="mx-auto max-w-[1800px] overflow-hidden rounded-[34px] border border-white bg-white shadow-[0_30px_100px_rgba(15,23,42,.11)] ring-1 ring-slate-200/80">
        <header className="relative overflow-hidden border-b border-slate-200 bg-[linear-gradient(135deg,#ffffff,#eff6ff_52%,#ecfdf5)] px-5 py-6 lg:px-8 lg:py-7">
          ...
          {data ? <div className="relative mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-6">{[
            [MessageCircleMore, "Espaces actifs", data.counts.active_workspaces, "blue"],
            [Users, "Affectations", data.counts.active_assignments, "violet"],
            [Laptop2, "Appareils", data.counts.devices, "slate"],
            [Wifi, "En ligne", data.counts.online_devices, "green"],
            [Clock3, "En attente", data.counts.pending_devices + data.counts.pending_requests, "amber"],
            [ShieldAlert, "Alertes ouvertes", data.counts.open_security_events, data.counts.open_security_events ? "red" : "green"],
