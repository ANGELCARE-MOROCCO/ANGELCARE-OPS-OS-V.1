...
async function createProfile() {
    ...
    try {
      const json = await api('/api/carelink/ops/agents/create', {
        ...
        preferred_zones: splitList(preferredZones),
        excluded_zones: splitList(excludedZones),
        accepts_weekends: acceptWeekends,
        accepts_night: acceptNight,
        accepts_emergency_replacement: acceptEmergency,
