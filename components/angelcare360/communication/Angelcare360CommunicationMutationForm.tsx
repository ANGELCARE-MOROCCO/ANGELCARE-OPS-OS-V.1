...
export type Angelcare360CommunicationMutationField = {
  name: string
  label: string
...
type Props = {
  ...
  operation: string
  submitLabel: string
  fields: Angelcare360CommunicationMutationField[]
  endpoint?: string
...
export default function Angelcare360CommunicationMutationForm({ title, description, entity, operation, submitLabel, fields, endpoint = '/api/angelcare360/communication', initialValues, recordId, schoolId, lockedReason }: Props) {
