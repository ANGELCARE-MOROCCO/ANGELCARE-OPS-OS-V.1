...
export type Angelcare360CommunicationNavigationItem = {
  key: string
  label: string
  href: string
  summary: string
...
type Props = {
  items: Angelcare360CommunicationNavigationItem[]
}

export default function Angelcare360CommunicationNavigation({ items }: Props) {
  return (
    <nav style={navStyle}>
      {items.map((item) => (
