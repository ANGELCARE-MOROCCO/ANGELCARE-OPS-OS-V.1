...
type Props = {
  items: Angelcare360LibraryNavigationItem[]
}

export default function Angelcare360LibraryNavigation({ items }: Props) {
  const pathname = usePathname() || '/angelcare-360-command-center/bibliotheque'

  return (
    <nav style={navStyle} aria-label="Navigation bibliothèque AngelCare 360">
      {items.map((item) => {
