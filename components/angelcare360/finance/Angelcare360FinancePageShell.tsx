...
import Angelcare360FinanceNavigation from './Angelcare360FinanceNavigation'
import type { Angelcare360FinanceNavigationItem } from '@/data/angelcare360/finance-navigation'
import {
  ANGELCARE360_COLORS,
...
type Angelcare360FinancePageShellProps = {
  title: string
  subtitle: string
  badge?: string
  statusLabel?: string
  ...
  navigationItems: Angelcare360FinanceNavigationItem[]
  children: ReactNode
}

export default function Angelcare360FinancePageShell({
  title,
  subtitle,
  badge,
  statusLabel,
  ...
  navigationItems,
  children,
}: Angelcare360FinancePageShellProps) {
  return (
    <section style={shellStyle}>
      ...
      <Angelcare360FinanceNavigation items={navigationItems} />
