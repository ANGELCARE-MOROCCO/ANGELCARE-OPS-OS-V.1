...
type Angelcare360TimetableNavigationProps = {
  items: Angelcare360TimetableNavigationItem[]
}

export default function Angelcare360TimetableNavigation({ items }: Angelcare360TimetableNavigationProps) {
  const pathname = usePathname() || '/angelcare-360-command-center/emploi-du-temps'

  return (
    <nav style={navStyle} aria-label="Navigation emploi du temps AngelCare 360">
      {items.map((item) => {
