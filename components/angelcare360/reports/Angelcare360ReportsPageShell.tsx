...
import Angelcare360ReportsNavigation from './Angelcare360ReportsNavigation'
...
type Props = {
  ...
  navigationItems: Angelcare360ReportsNavigationItem[]
  primaryAction?: ReactNode
  secondaryActions?: ReactNode
  children: ReactNode
}

export default function Angelcare360ReportsPageShell({
  title,
  subtitle,
  badge,
  statusLabel,
  ...
  return (
    <section style={shellStyle}>
      ...
      <Angelcare360ReportsNavigation items={navigationItems} />
