...
const shellStyle: React.CSSProperties = {
  ...
  position: 'relative',
  background:
    'radial-gradient(circle at top left, rgba(59,130,246,.10), transparent 24%), radial-gradient(circle at top right, rgba(14,165,233,.08), transparent 20%), linear-gradient(180deg, #f8fafc 0%, #eef4fb 100%)',
  color: '#0f172a',
}
...
const shellBackdropStyle: React.CSSProperties = {
  ...
  pointerEvents: 'none',
  background:
    'linear-gradient(135deg, rgba(255,255,255,.55) 0%, rgba(255,255,255,.20) 100%)',
}
