...
type Angelcare360AttendanceNavigationProps = {
  items: Angelcare360AttendanceNavigationItem[]
}

export default function Angelcare360AttendanceNavigation({ items }: Angelcare360AttendanceNavigationProps) {
  const pathname = usePathname() || '/angelcare-360-command-center/presences'

  return (
    <nav style={navStyle} aria-label="Navigation présences AngelCare 360">
      {items.map((item) => {
