...
export default function Angelcare360InventoryRiskPanel({ title = 'Risques inventaire', risks }: Props) {
  return (
    <section style={cardStyle}>
      <div style={headerStyle}>
        <div>
          <div style={eyebrowStyle}>Contrôle des stocks</div>
      ...
      {risks.length > 0 ? (
        ...
        <Angelcare360EmptyState title="Aucun risque bloquant" description="L’inventaire ne détecte pas de rupture immédiate." />
      )}
    </section>
  )
}
