...
const kpis = [{"label": "Training Rate", "value": "90%", "icon": "GraduationCap", "color": "text-violet-600"}, {"label": "Certified", "value": "42", "icon": "BadgeCheck", "color": "text-emerald-600"}, {"label": "Pending", "value": "11", "icon": "Clock", "color": "text-blue-600"}, {"label": "Overdue", "value": "3", "icon": "AlertTriangle", "color": "text-rose-600"}, {"label": "Skill Gaps", "value": "7", "icon": "Target", "color": "text-orange-600"}]
const rows = [["Product knowledge certification", "Training Lead", "Assessment", 86, "Open"], ["B2B objection training", "Academy", "Training", 78, "In Progress"], ["Proof quality refresher", "Quality Control", "Remediation", 69, "Critical"], ["Field script mastery", "Regional Manager", "Certification", 91, "Approved"]]
const actions = [{"key": "trn-0", "label": "Create Course", "icon": "GraduationCap", "description": "Build a training course with modules, assessment and certification outcome.", "ref": "AC-MOS-AMB-TRN-001", "workflow": ["Define objective", "Add modules", "Create assessment", "Set passing rule", "Publish course"], "controls": ["Unique reference ID", "Owner assigned", "Deadline required", "Audit log", "Role-gated approval"], "ai": ["Use this workflow only with owner and deadline.", "Create action tasks automatically after execution.", "Sync output to reports and ambassador profile."]}, {"key": "trn-1", "label": "Certify Ambassador", "icon": "BadgeCheck", "description": "Approve readiness for specific field missions.", "ref": "AC-MOS-AMB-TRN-002", "workflow": ["Review score", "Validate proof", "Select scope", "Issue certificate", "Notify manager"], "controls": ["Unique reference ID", "Owner assigned", "Deadline required", "Audit log", "Role-gated approval"], "ai": ["Use this workflow only with owner and deadline.", "Create action tasks automatically after execution.", "Sync output to reports and ambassador profile."]}, {"key": "trn-2", "label": "Launch Assessment", "icon": "ClipboardCheck", "description": "Launch a test or practical evaluation with pass/fail rules.", "ref": "AC-MOS-AMB-TRN-003", "workflow": ["Select skills", "Create questions", "Set pass mark", "Launch test", "Review results"], "controls": ["Unique reference ID", "Owner assigned", "Deadline required", "Audit log", "Role-gated approval"], "ai": ["Use this workflow only with owner and deadline.", "Create action tasks automatically after execution.", "Sync output to reports and ambassador profile."]}, {"key": "trn-3", "label": "Assign Remediation", "icon": "Target", "description": "Assign targeted retraining for weak skills.", "ref": "AC-MOS-AMB-TRN-004", "workflow": ["Identify gap", "Assign content", "Set deadline", "Schedule retest", "Release lock"], "controls": ["Unique reference ID", "Owner assigned", "Deadline required", "Audit log", "Role-gated approval"], "ai": ["Use this workflow only with owner and deadline.", "Create action tasks automatically after execution.", "Sync output to reports and ambassador profile."]}, {"key": "trn-4", "label": "Issue Badge", "icon": "Trophy", "description": "Issue certification badge linked to skills and mission eligibility.", "ref": "AC-MOS-AMB-TRN-005", "workflow": ["Select badge", "Confirm eligibility", "Set expiry", "Issue badge", "Notify ambassador"], "controls": ["Unique reference ID", "Owner assigned", "Deadline required", "Audit log", "Role-gated approval"], "ai": ["Use this workflow only with owner and deadline.", "Create action tasks automatically after execution.", "Sync output to reports and ambassador profile."]}, {"key": "trn-5", "label": "Export Certifications", "icon": "Download", "description": "Export completion, certifications, gaps and expiry risk.", "ref": "AC-MOS-AMB-TRN-006", "workflow": ["Select scope", "Pick fields", "Generate export", "Share report", "Archive"], "controls": ["Unique reference ID", "Owner assigned", "Deadline required", "Audit log", "Role-gated approval"], "ai": ["Use this workflow only with owner and deadline.", "Create action tasks automatically after execution.", "Sync output to reports and ambassador profile."]}]
...
export default function AmbassadorTrainingCertificationWorkspace() {
  ...
  function exportCsv() {
    ...
    a.href = url
    a.download = "training-certification-workspace-export.csv"
    a.click()
  ...
  return (
    <div className="flex min-h-screen bg-white text-slate-950">
      ...
      <main className="flex-1 bg-white px-8 py-7">
        <header className="mb-6 flex items-start justify-between"><div><div className="text-xs font-black uppercase tracking-[0.24em] text-violet-600">Ambassador Management</div><h1 className="mt-2 text-[32px] font-black tracking-tight">Training & Certification Academy</h1><p className="mt-1 text-sm font-semibold text-slate-500">Train, assess, certify and control ambassador readiness before field deployment.</p></div><div className="flex gap-2"><button onClick={exportCsv} className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-black shadow-sm"><Download size={16} />Export</button><button onClick={() => setActive(actions[0])} className="inline-flex items-center gap-2 rounded-xl bg-violet-600 px-4 py-3 text-sm font-black text-white shadow-lg shadow-violet-100"><Plus size={16} />New Action</button></div></header>
