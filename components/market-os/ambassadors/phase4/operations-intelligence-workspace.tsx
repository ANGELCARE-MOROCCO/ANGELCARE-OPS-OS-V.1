    ...
    <main className="min-h-screen bg-slate-100 p-4 text-slate-950 md:p-6">
      <div className="mx-auto max-w-7xl space-y-5">
        <header className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-xs font-bold uppercase tracking-[0.24em] text-slate-500">AngelCare Ambassador OS · Phase 4</p>
          <div className="mt-2 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm">
              ...
              <p className="text-xs text-slate-500">{new Date(snapshot.generatedAt).toLocaleString()}</p>
            </div>
          </div>
        </header>
