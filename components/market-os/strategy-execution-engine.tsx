            ...
            return (
              <article key={task.id} className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  ...
                  <MarketActionButton moduleKey="strategy-execution-engine" actionKey="add_proof" actionLabel="Add Proof" className="rounded-2xl border border-slate-200 px-4 py-2 text-sm font-bold">
                    Add Proof
                  </MarketActionButton>
                  <MarketActionButton moduleKey="strategy-execution-engine" actionKey="escalate" actionLabel="Escalate" className="rounded-2xl border border-slate-200 px-4 py-2 text-sm font-bold">
                    Escalate
                  </MarketActionButton>
                </div>
              </article>
