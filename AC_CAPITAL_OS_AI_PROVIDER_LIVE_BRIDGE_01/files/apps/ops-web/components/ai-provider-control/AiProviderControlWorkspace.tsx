...
type TabKey = 'command' | 'revenue' | 'command-policies' | 'schedules' | 'reuse' | 'dossiers' | 'credentials' | 'assignments' | 'routing' | 'capacity' | 'models' | 'grounding' | 'usage' | 'costs' | 'incidents' | 'versions' | 'audit' | 'simulation'
