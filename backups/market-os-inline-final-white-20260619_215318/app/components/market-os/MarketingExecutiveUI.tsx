...
const sidebar: React.CSSProperties = { height: '100vh', position: 'sticky', top: 0, overflowY: 'auto', padding: 22, background: 'linear-gradient(180deg,#020617,#040816)', borderRight: '1px solid rgba(148,163,184,.16)', display: 'grid', alignContent: 'start', gap: 18 }
