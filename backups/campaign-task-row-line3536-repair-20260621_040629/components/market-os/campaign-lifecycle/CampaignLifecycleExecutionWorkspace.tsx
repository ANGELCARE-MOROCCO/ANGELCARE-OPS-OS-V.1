  ...
  return (
    <main data-campaign-lifecycle-root="true" data-active-panel={activePanel} onClickCapture={handleCampaignLifecycleActionCapture} className="min-h-screen bg-white text-slate-950">
                          ...
                          <div className="flex items-start justify-between gap-4">
                            <div className="min-w-0">
                              <div className="flex flex-wrap items-center gap-2">
                                ...
                                <Pill tone={campaignLifecycleStatus(selectedManagementCampaign) === "active" ? "emerald" : campaignLifecycleStatus(selectedManagementCampaign) === "paused" ? "amber" : "slate"}>
                              ...
                              <div className="mt-4 flex flex-wrap gap-2">
                                ...
                                <Pill tone={riskTone(selectedManagementCampaign.risk)}>{riskLabel[selectedManagementCampaign.risk]}</Pill>
                              </div>
                            </div>
                                  ...
                                  <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    <Field label="Stage">
                                      <Select
                                        ...
                                        onChange={(event) => updateCampaign(selectedManagementCampaign.id, { stage: event.target.value as CampaignStage }, "Campaign stage updated")}
                                      >
                                        {stages.map((stage) => <option key={stage} value={stage}>{stageLabel[stage]}</option>)}
                                      </Select>
                                    </Field>
                        ...
                        <div className="min-w-[980px] space-y-3">
                          {filteredTaskOps.length ? filteredTaskOps.map((task) => {
                            ...
                            return (
                              <button
                                key={task.id}
                                type="button" data-task-ops-row="true"
                                  data-task-ops-row="true"
                                onClick={() = data-task-ops-row-force="true"> setSelectedTaskOpsId(task.id)}
      ...
      {modalOpen ? (
        ...
        [data-campaign-lifecycle-root="true"] [data-task-ops-center="true"] button[data-task-ops-row="true"] {
          display: grid !important;
        ...
        [data-campaign-lifecycle-root="true"] [data-task-ops-center="true"] button[data-task-ops-row="true"]:hover {
          display: grid !important;
        ...
        [data-campaign-lifecycle-root="true"] [data-task-ops-center="true"] button[data-task-ops-row="true"] > div {
          border-radius: 20px !important;
        }

        [data-campaign-lifecycle-root="true"] [data-task-ops-center="true"] button[data-task-ops-row="true"] > div:not(:first-child) {
        ...
        [data-campaign-lifecycle-root="true"] [data-task-ops-center="true"] button[data-task-ops-row="true"] p,
        [data-campaign-lifecycle-root="true"] [data-task-ops-center="true"] button[data-task-ops-row="true"] span {
          white-space: normal !important;
        }

        [data-campaign-lifecycle-root="true"] [data-task-ops-center="true"] button[data-task-ops-row="true"] p[class*="truncate"] {
          overflow: visible !important;
          text-overflow: clip !important;
          white-space: normal !important;
        }

        [data-campaign-lifecycle-root="true"] [data-task-ops-center="true"] button[data-task-ops-row="true"] span[class*="rounded-full"] {
          display: inline-flex !important;
          align-items: center !important;
          justify-content: center !important;
        ...
        [data-task-ops-center="true"] button[data-task-ops-row="true"] {
          all: unset;
        ...
        [data-task-ops-center="true"] button[data-task-ops-row="true"]:hover {
          transform: translateY(-2px) !important;
        ...
        [data-task-ops-center="true"] button[data-task-ops-row="true"] > div {
        ...
        [data-task-ops-center="true"] button[data-task-ops-row="true"] > div:first-child {
          display: grid !important;
        ...
        [data-task-ops-center="true"] button[data-task-ops-row="true"] > div:not(:first-child) {
        ...
        [data-task-ops-center="true"] button[data-task-ops-row="true"] p,
        [data-task-ops-center="true"] button[data-task-ops-row="true"] span {
          white-space: normal !important;
          overflow: visible !important;
          text-overflow: clip !important;
        ...
        [data-task-ops-center="true"] button[data-task-ops-row="true"] span[class*="rounded-full"] {
          display: inline-flex !important;
