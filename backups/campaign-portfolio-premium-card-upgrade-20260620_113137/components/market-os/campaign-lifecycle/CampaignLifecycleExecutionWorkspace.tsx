                  ...
                  {filteredCampaigns.length ? (
                    <div className="grid gap-3 2xl:grid-cols-2">
                      {filteredCampaigns.map((campaign) => (
                        <div key={campaign.id} className="rounded-[28px] border border-slate-200 bg-gradient-to-br from-white via-white to-slate-50 p-5 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-[0_22px_55px_rgba(15,23,42,0.08)]">
                          ...
                          <div className="mt-4 grid gap-2 md:grid-cols-4">
                            <div className="rounded-[18px] border border-slate-100 bg-white p-3 shadow-sm"><p className="text-[10px] font-black text-slate-400">Stage</p><p className="text-sm font-black">{stageLabel[campaign.stage]}</p></div>
                            <div className="rounded-[18px] border border-slate-100 bg-white p-3 shadow-sm"><p className="text-[10px] font-black text-slate-400">Readiness</p><p className="text-sm font-black">{pct(campaign.readiness)}</p></div>
                            <div className="rounded-[18px] border border-slate-100 bg-white p-3 shadow-sm"><p className="text-[10px] font-black text-slate-400">Spend</p><p className="text-sm font-black">{mad(campaign.spentMad)}</p></div>
                            <div className="rounded-[18px] border border-slate-100 bg-white p-3 shadow-sm"><p className="text-[10px] font-black text-slate-400">ROAS</p><p className="text-sm font-black">{roas(campaign)}x</p></div>
                          </div>
                          <div className="mt-4 flex flex-wrap gap-2">
                            <button onClick={() => setState({ ...state, selectedId: campaign.id })} className="rounded-2xl border border-slate-200 bg-white px-4 py-2 text-xs font-black shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">Select</button>
