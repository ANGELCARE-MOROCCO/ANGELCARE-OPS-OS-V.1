...
const mainNavItems = [
  { title: 'Dashboard', url: '/market-os/ambassadors/refferq/affiliate', icon: LayoutDashboard },
  { title: 'Referrals', url: '/market-os/ambassadors/refferq/affiliate/referrals', icon: Users },
  { title: 'Payouts', url: '/market-os/ambassadors/refferq/affiliate/payouts', icon: Wallet },
  { title: 'Resources', url: '/market-os/ambassadors/refferq/affiliate/resources', icon: BookOpen },
  { title: 'Reports', url: '/market-os/ambassadors/refferq/affiliate/reports', icon: BarChart3, badge: 'BETA' },
];

const accountNavItems = [
  { title: 'Settings', url: '/market-os/ambassadors/refferq/affiliate/settings', icon: Settings },
];
...
function AffiliateSidebar({ brand }: { brand: BrandSettings }) {
  ...
  const isActive = (url: string) => {
    if (url === '/market-os/ambassadors/refferq/affiliate') return pathname === '/market-os/ambassadors/refferq/affiliate';
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              ...
              <DropdownMenuContent
                ...
                sideOffset={4}
              >
                <DropdownMenuItem onClick={() => router.push('/market-os/ambassadors/refferq/affiliate/settings')}>
...
export default function AffiliateLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    fetch('/api/market-os/refferq/affiliate/branding')
      .then(res => res.json())
      .then(data => {
