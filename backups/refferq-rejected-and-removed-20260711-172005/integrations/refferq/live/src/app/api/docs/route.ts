...
export async function GET(request: NextRequest) {
    const spec = {
        ...
        paths: {
            // ─── Auth ──────────────────────────────────────────────
            '/api/market-os/refferq/auth/login': {
                post: {
                    tags: ['Auth'],
                    summary: 'Login',
                    requestBody: {
            ...
            // ─── Affiliate ─────────────────────────────────────────
            '/api/market-os/refferq/affiliate/profile': {
                get: {
                    tags: ['Affiliate'],
            ...
            '/api/market-os/refferq/affiliate/referrals': {
                post: {
                    tags: ['Affiliate'],
            ...
            '/api/market-os/refferq/affiliate/payouts': {
                get: {
                    tags: ['Affiliate'],
            ...
            // ─── Admin ─────────────────────────────────────────────
            '/api/market-os/refferq/admin/affiliates': {
                get: {
                    tags: ['Admin'],
            ...
            '/api/market-os/refferq/admin/payouts': {
                get: {
                    tags: ['Admin'],
            ...
            '/api/market-os/refferq/admin/analytics': {
                get: {
                    tags: ['Admin'],
            ...
            '/api/market-os/refferq/admin/reports': {
                get: {
                    tags: ['Admin'],
            ...
            // ─── Tracking ──────────────────────────────────────────
            '/market-os/ambassadors/refferq/r/{code}': {
                get: {
                    tags: ['Tracking'],
            ...
            // ─── Webhooks ──────────────────────────────────────────
            '/api/market-os/refferq/webhook/conversion': {
                post: {
                    tags: ['Webhooks'],
