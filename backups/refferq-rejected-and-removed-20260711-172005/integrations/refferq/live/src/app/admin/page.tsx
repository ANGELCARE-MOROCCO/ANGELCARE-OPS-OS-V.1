...
import { Progress } from '@refferq/components/ui/progress';
...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from '@refferq/components/ui/tooltip';
import {
  TrendingUp,
  IndianRupee,
  Users,
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [statsRes, analyticsRes, referralsRes] = await Promise.all([
        fetch('/api/market-os/refferq/admin/dashboard'),
        fetch('/api/market-os/refferq/admin/analytics?days=30'),
        fetch('/api/market-os/refferq/admin/referrals'),
      ]);
  ...
  const quickActions = [
    {
      ...
      icon: Users,
      href: '/market-os/ambassadors/refferq/admin/partners',
      color: 'text-blue-600',
      bg: 'bg-blue-500/10',
    },
    {
      ...
      icon: UserCheck,
      href: '/market-os/ambassadors/refferq/admin/customers',
      color: 'text-emerald-600',
      bg: 'bg-emerald-500/10',
    },
    {
      ...
      icon: CreditCard,
      href: '/market-os/ambassadors/refferq/admin/payouts',
      color: 'text-amber-600',
      bg: 'bg-amber-500/10',
    },
    {
      ...
      icon: BarChart3,
      href: '/market-os/ambassadors/refferq/admin/reports',
      color: 'text-violet-600',
      bg: 'bg-violet-500/10',
    },
  ];
                ...
                {(stats?.pendingReferrals || 0) > 0 && (
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => router.push('/market-os/ambassadors/refferq/admin/customers')}>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              ...
              <Button variant="ghost" size="sm" className="text-xs" onClick={() => router.push('/market-os/ambassadors/refferq/admin/partners')}>
                View all
                ...
                <div className="space-y-1">
                  {topAffiliates.map((affiliate: any, index: number) => (
                    <div
                      ...
                      onClick={() => router.push(`/market-os/ambassadors/refferq/admin/partners/${affiliate.id}`)}
                    >
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              ...
              <Button variant="ghost" size="sm" className="text-xs" onClick={() => router.push('/market-os/ambassadors/refferq/admin/customers')}>
                View all
                <ArrowRight className="ml-1 h-3 w-3" />
              </Button>
            </CardHeader>
