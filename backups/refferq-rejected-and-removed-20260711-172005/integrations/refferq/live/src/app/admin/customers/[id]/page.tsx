...
import {
  ...
  AlertDialogTitle,
  AlertDialogTrigger,
} from '@refferq/components/ui/alert-dialog';
import {
  ArrowLeft,
  Mail,
  Phone,
...
export default function CustomerDetailPage() {
  ...
  const handleSave = async () => {
    ...
    setSaved(false);
    try {
      const res = await fetch(`/api/market-os/refferq/admin/referrals/${id}`, {
        method: 'PATCH',
  ...
  const handleDelete = async () => {
    setDeleting(true);
    try {
      const res = await fetch(`/api/market-os/refferq/admin/referrals/${id}`, { method: 'DELETE' });
      if (res.ok) {
        router.push('/market-os/ambassadors/refferq/admin/customers');
      }
    } catch (error) {
  ...
  if (!referral) {
    return (
      <div className="space-y-6">
        <Button variant="ghost" onClick={() => router.push('/market-os/ambassadors/refferq/admin/customers')}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" onClick={() => router.push('/market-os/ambassadors/refferq/admin/customers')}>
