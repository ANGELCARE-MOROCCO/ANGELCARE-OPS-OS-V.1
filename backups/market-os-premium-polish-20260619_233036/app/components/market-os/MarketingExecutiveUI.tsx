...
const hero: React.CSSProperties = { display: 'grid', gridTemplateColumns: '1fr 350px', gap: 20, padding: 30, borderRadius: 28, background: 'radial-gradient(circle at 48% 0%,rgba(124,58,237,.10),transparent 44%),radial-gradient(circle at 8% 10%,rgba(14,165,233,.10),transparent 30%),linear-gradient(135deg,#ffffff,#f8fafc)', border: '1px solid #dbeafe', boxShadow: '0 24px 70px rgba(15,23,42,.08)' }
...
const heroIcon: React.CSSProperties = { width: 70, height: 70, borderRadius: 24, display: 'grid', placeItems: 'center', fontSize: 30, background: 'linear-gradient(135deg,#0ea5e9,#7c3aed)', boxShadow: '0 18px 44px rgba(59,130,246,.22)' }
