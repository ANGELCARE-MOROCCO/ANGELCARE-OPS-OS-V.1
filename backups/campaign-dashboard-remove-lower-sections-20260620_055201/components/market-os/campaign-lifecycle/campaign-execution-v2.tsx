      ...
      {/* Restored dashboard hero removed permanently.
        ...
        <section className="overflow-hidden rounded-[38px] border border-slate-200 bg-white/95 p-6 shadow-[0_30px_90px_rgba(15,23,42,0.08)] lg:p-7">
          ...
          <div className="mt-6 grid gap-4 xl:grid-cols-12">
            <div className="rounded-[30px] border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-5 xl:col-span-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="grid h-11 w-11 place-items-center rounded-[18px] bg-slate-950 text-sm font-black text-white">
                  ◎
                </span>
              </div>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                {stages.slice(0, 5).map((stage) => {
                  const count = store.campaigns.filter((campaign) => campaign.stage === stage).length
                  const active = selected ? selected.stage === stage : false
            ...
            <div className="rounded-[30px] border border-slate-200 bg-gradient-to-br from-white to-slate-50 p-5 xl:col-span-4">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.22em] text-slate-400">
                    Selected campaign
                ...
                <span className="grid h-11 w-11 place-items-center rounded-[18px] bg-violet-50 text-sm font-black text-violet-700">
                  ↗
                </span>
              </div>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-[22px] border border-slate-200 bg-white p-4 shadow-sm">
                  ...
                  <p className="mt-3 text-2xl font-black tracking-[-0.04em] text-slate-950">
                    {selected && selected.spentMad
                      ? `${Math.round((selected.revenueMad / selected.spentMad) * 10) / 10}x`
                      : "—"}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4 rounded-[22px] border border-slate-200 bg-white p-4 shadow-sm">
                <div className="grid gap-3 sm:grid-cols-3">
                  <div>
                    ...
                    <p className="mt-2 text-sm font-black text-slate-700">{selected ? selected.owner : "—"}</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">Launch</p>
                    <p className="mt-2 text-sm font-black text-slate-700">{selected ? selected.launchDate : "—"}</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">Stage</p>
                    <p className="mt-2 text-sm font-black text-slate-700">{selected ? label(selected.stage) : "—"}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[30px] border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-5 xl:col-span-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="grid h-11 w-11 place-items-center rounded-[18px] bg-amber-50 text-sm font-black text-amber-700">
                  ⚡
                </span>
              </div>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                <button
                  ...
                  className="group rounded-[24px] border border-slate-200 bg-white p-4 text-left shadow-sm transition hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md"
                >
                  <div className="flex items-start gap-3">
                    <span className="grid h-11 w-11 place-items-center rounded-[16px] bg-slate-950 text-lg font-black text-white">
                      +
                    </span>
                    <div>
                      <p className="text-base font-black text-slate-950">Create campaign</p>
                      <p className="mt-1 text-xs font-bold text-slate-500">Open creation studio</p>
                    </div>
                  </div>
                </button>
                ...
                >
                  <div className="flex items-start gap-3">
                    <span className="grid h-11 w-11 place-items-center rounded-[16px] bg-emerald-50 text-lg font-black text-emerald-700">
                      ↺
                    </span>
                    <div>
                      <p className="text-base font-black text-slate-950">Restore seed</p>
                      <p className="mt-1 text-xs font-bold text-slate-500">Reload base records</p>
                    </div>
                  </div>
                </button>
                ...
                {selected ? (
                  <Link
                    href={`/market-os/campaign-lifecycle/${selected.id}`}
                    className="group rounded-[24px] border border-slate-200 bg-white p-4 text-left shadow-sm transition hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md"
                  >
                    <div className="flex items-start gap-3">
                      <span className="grid h-11 w-11 place-items-center rounded-[16px] bg-violet-50 text-lg font-black text-violet-700">
                        ↗
                      </span>
                      <div>
                        <p className="text-base font-black text-slate-950">Open command</p>
                        <p className="mt-1 text-xs font-bold text-slate-500">Selected campaign cockpit</p>
                      </div>
                    </div>
                  </Link>
                ) : (
                  <div className="rounded-[24px] border border-slate-200 bg-white p-4 text-left shadow-sm opacity-60">
                    <div className="flex items-start gap-3">
                      <span className="grid h-11 w-11 place-items-center rounded-[16px] bg-slate-100 text-lg font-black text-slate-500">
                        ↗
                      </span>
                      <div>
                        <p className="text-base font-black text-slate-700">Open command</p>
                        <p className="mt-1 text-xs font-bold text-slate-400">Select a campaign first</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                >
                  <div className="flex items-start gap-3">
                    <span className="grid h-11 w-11 place-items-center rounded-[16px] bg-sky-50 text-lg font-black text-sky-700">
                      ←
                    </span>
                    <div>
                      <p className="text-base font-black text-slate-950">Back to Market OS</p>
                      <p className="mt-1 text-xs font-bold text-slate-500">Return to main workspace</p>
                    </div>
                  </div>
                </Link>
              </div>
