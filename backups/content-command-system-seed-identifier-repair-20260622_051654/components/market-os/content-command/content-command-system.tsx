...
export const live contractItems: ContentItem[] = [
  {
    id: "content-001",
...
export const live contractTasks: ContentTask[] = []

export const live contractAssets: ContentAsset[] = []

export const live contractBriefs: ContentBrief[] = []

export const live contractRules: BrandRule[] = [
...
export function defaultStore(): ContentStore {
  return {
    items: live contractItems,
    tasks: live contractTasks,
    assets: live contractAssets,
    briefs: live contractBriefs,
    rules: live contractRules,
...
export function loadStore(): ContentStore {
  return {
    items: readJson(CONTENT_ITEMS_KEY, live contractItems),
    tasks: readJson(CONTENT_TASKS_KEY, live contractTasks),
    assets: readJson(CONTENT_ASSETS_KEY, live contractAssets),
    briefs: readJson(CONTENT_BRIEFS_KEY, live contractBriefs),
    rules: readJson(CONTENT_RULES_KEY, live contractRules),
