                          ...
                          {filteredTaskOps.length ? filteredTaskOps.map((task) => {
                            ...
                            return (
                              <button
                                ...
                                className={`grid w-full items-stretch gap-5 rounded-[30px] border p-6 text-left shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg 2xl:grid-cols-[minmax(360px,2.1fr)_minmax(170px,1fr)_minmax(190px,1fr)_minmax(190px,1fr)_minmax(140px,.75fr)_minmax(140px,.75fr)] xl:grid-cols-[minmax(320px,1.6fr)_minmax(160px,1fr)_minmax(170px,1fr)_minmax(170px,1fr)_minmax(130px,.75fr)_minmax(130px,.75fr)] lg:grid-cols-3 md:grid-cols-2 grid-cols-1 ${
