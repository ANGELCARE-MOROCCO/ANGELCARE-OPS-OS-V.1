...
const page: React.CSSProperties = { minHeight: '100vh', display: 'grid', gridTemplateColumns: '300px 1fr', background: 'linear-gradient(135deg,#ffffff 0%,#f8fafc 54%,#eef6ff 100%)', color: '#020617', fontFamily: 'Inter, Arial, sans-serif' }
const sidebar: React.CSSProperties = { height: '100vh', position: 'sticky', top: 0, overflowY: 'auto', padding: 22, background: 'linear-gradient(180deg,#ffffff,#f8fafc)', borderRight: '1px solid #e2e8f0', display: 'grid', alignContent: 'start', gap: 18, boxShadow: '12px 0 34px rgba(15,23,42,.05)' }
...
const navActive: React.CSSProperties = { ...navItem, background: 'linear-gradient(135deg,#eef2ff,#dbeafe)', color: '#1e1b4b', border: '1px solid #c7d2fe', boxShadow: '0 14px 32px rgba(79,70,229,.14)' }
...
const assistantInput: React.CSSProperties = { padding: '12px 13px', borderRadius: 12, border: '1px solid #e2e8f0', background: '#ffffff', color: '#020617', boxShadow: '0 10px 24px rgba(15,23,42,.05)' }
...
const search: React.CSSProperties = { padding: '15px 17px', borderRadius: 15, background: '#0d1726', border: '1px solid rgba(148,163,184,.14)', color: '#64748b' }
const topButtons: React.CSSProperties = { display: 'flex', gap: 10 }
const hero: React.CSSProperties = { display: 'grid', gridTemplateColumns: '1fr 350px', gap: 20, padding: 28, borderRadius: 26, background: 'radial-gradient(circle at 48% 0%,rgba(124,58,237,.12),transparent 44%),radial-gradient(circle at 8% 10%,rgba(14,165,233,.10),transparent 30%),linear-gradient(135deg,#ffffff,#f8fafc)', border: '1px solid #dbeafe', boxShadow: '0 28px 80px rgba(15,23,42,.10)' }
...
const kpiCard: React.CSSProperties = { padding: 16, borderRadius: 18, background: 'linear-gradient(180deg,#ffffff,#f8fafc)', border: '1px solid #e2e8f0', color: '#020617', textDecoration: 'none', display: 'grid', gap: 8, minHeight: 142, boxShadow: '0 16px 40px rgba(15,23,42,.07)' }
...
const panel: React.CSSProperties = { padding: 18, borderRadius: 20, background: 'linear-gradient(180deg,#ffffff,#f8fafc)', border: '1px solid #e2e8f0', boxShadow: '0 18px 48px rgba(15,23,42,.08)' }
...
const activeSeg: React.CSSProperties = { ...seg, background: 'linear-gradient(135deg,#7c3aed,#0ea5e9)', color: '#020617' }
const chartBox: React.CSSProperties = { height: 350, borderRadius: 16, background: 'radial-gradient(circle at 40% 20%,rgba(34,197,94,.10),transparent 45%),#ffffff', overflow: 'hidden', position: 'relative', border: '1px solid #e2e8f0' }
...
const campaignRow: React.CSSProperties = { display: 'grid', gridTemplateColumns: '40px 1fr auto auto auto auto', gap: 10, alignItems: 'center', padding: 12, borderRadius: 14, background: '#ffffff', color: '#020617', textDecoration: 'none', marginBottom: 8, border: '1px solid #e2e8f0', boxShadow: '0 10px 24px rgba(15,23,42,.04)' }
...
const insightRow: React.CSSProperties = { display: 'grid', gap: 6, padding: 13, borderRadius: 14, background: '#ffffff', color: '#020617', textDecoration: 'none', marginBottom: 8, border: '1px solid #e2e8f0', boxShadow: '0 10px 24px rgba(15,23,42,.04)' }
...
const contentRow: React.CSSProperties = { display: 'grid', gridTemplateColumns: '1fr auto auto auto', gap: 10, padding: 11, color: '#020617', textDecoration: 'none', borderBottom: '1px solid #e2e8f0' }
...
const activityRow: React.CSSProperties = { display: 'grid', gridTemplateColumns: '84px 1fr 150px 110px 70px', gap: 10, padding: 11, color: '#020617', textDecoration: 'none', borderBottom: '1px solid #e2e8f0' }
const quickActions: React.CSSProperties = { display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 10 }
const quickAction: React.CSSProperties = { minHeight: 92, borderRadius: 16, background: '#ffffff', color: '#020617', textDecoration: 'none', display: 'grid', placeItems: 'center', textAlign: 'center', padding: 12, border: '1px solid #e2e8f0', boxShadow: '0 12px 28px rgba(15,23,42,.05)' }
