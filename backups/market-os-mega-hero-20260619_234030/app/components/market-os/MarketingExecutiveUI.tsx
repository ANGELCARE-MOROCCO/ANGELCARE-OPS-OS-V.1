      ...
      <main style={main}>
        ...
        <section style={hero}>
          <div style={heroIdentity}>
            ...
            <div>
              <span style={eyebrow}>ANGELCARE • MARKET OS</span>
              <h1><span>AngelCare Marketing</span> Growth Control Center</h1>
              <p>Enterprise command surface for acquisition, campaigns, content governance, partnerships and revenue orchestration.</p>

              <div style={heroActions}>
                <Link href="/market-os/campaign-lifecycle"><span>🎯</span> Campaign Operations</Link>
                <Link href="/market-os/content-command-center"><span>🧠</span> Content Governance</Link>
                <Link href="/revenue-command-center"><span>💎</span> Revenue Intelligence</Link>
              </div>
            </div>
          </div>
          ...
          <div style={liveCard}>
            <div style={liveTop}>
              <b><span>●</span> ANGELCARE Sync</b>
              <span>{status === 'live' ? 'LIVE' : 'SAFE'}</span>
            </div>
            <strong>{status === 'live' ? 'Production synchronization active' : 'Safe operating mode'}</strong>
