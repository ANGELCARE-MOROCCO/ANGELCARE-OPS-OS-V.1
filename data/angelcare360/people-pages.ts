...
export function createStudentPeopleConfig(input: {
  ...
  return {
    ...
    searchableKeys: ['student_code', 'full_name', 'first_name', 'last_name', 'current_class_name', 'current_section_name', 'admission_status', 'status'],
...
export function createParentPeopleConfig(input: { schoolId: string }): Angelcare360PeopleEntityConfig {
  return {
    ...
    searchableKeys: ['parent_code', 'full_name', 'first_name', 'last_name', 'email', 'phone', 'whatsapp', 'child_names', 'status'],
    detailHrefKey: 'detail_href',
    statusField: 'status',
    statusValues: ['active', 'inactive', 'archived'],
    fields: [
...
export function createStaffPeopleConfig(input: { schoolId: string; staffType: 'teacher' | 'personnel' }): Angelcare360PeopleEntityConfig {
  ...
  return {
    ...
    fixedValues: { schoolId: input.schoolId },
    searchableKeys: ['staff_code', 'full_name', 'first_name', 'last_name', 'email', 'phone', 'department', 'staff_type', 'class_names', 'subject_names', 'status'],
    detailHrefKey: 'detail_href',
    statusField: 'status',
