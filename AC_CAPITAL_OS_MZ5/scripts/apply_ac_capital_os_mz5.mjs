...
console.log('AC CAPITAL OS MZ5 installer');
...
console.log('\nAC CAPITAL OS Mega ZIP 5 files copied successfully.');
...
console.log('MZ1 Foundation, MZ2 Cockpit, MZ3 Radar and MZ4 Qualification payload files are preserved in this integrated package.');
console.log('Next: node ./AC_CAPITAL_OS_MZ5/scripts/verify_ac_capital_os_mz5.mjs');
