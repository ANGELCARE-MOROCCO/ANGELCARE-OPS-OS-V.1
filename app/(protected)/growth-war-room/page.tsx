...
export default function Page() {
  ...
  return (
    <AppShell title="Growth War Room" subtitle="Market OS campaign command" breadcrumbs={[{ label: 'OPS OS', href: '/enterprise-command' }, { label: 'Growth War Room' }]} actions={<PageAction href="/opsos-final-qa" variant="light">Final QA</PageAction>}>
      <GlobalShell>
        <GlobalNavStrip items={nav} />
        <GlobalHero
          eyebrow="AngelCare OPS OS Mega Pack V1"
          title="Growth War Room"
          subtitle="Market OS growth surface for campaigns, content, ambassadors, SEO and acquisition execution."
          tone="amber"
          stats={[
        ...
        <GlobalPanel title="Growth Execution Domains" subtitle="Campaign and acquisition command zones." tone="amber">
          {OPSOS_MODULES.map((m) => (
