...
const B2B_PERMISSION_GROUP = {
  title: 'B2B Partnerships permissions',
  description: 'CRM, prospection, campagnes, templates, tâches, propositions, reporting et automation B2B.',
  permissions: [
