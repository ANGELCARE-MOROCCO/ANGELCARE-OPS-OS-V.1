...
export default async function Page() {
  ...
  return <>
    <div className="fixed inset-x-5 top-[124px] z-[80]"><HRModuleCommandBridge context="HR Approvals" compact />
      <HRRealtimeSyncPanel domain="approvals" title="Approvals realtime sync" compact /></div>
