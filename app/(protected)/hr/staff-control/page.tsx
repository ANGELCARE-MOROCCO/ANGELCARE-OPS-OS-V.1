...
export default function Page() {
  return (
    <AppShell
      title="HR Staff Control"
      subtitle="Department structure, staff capacity, ownership, permissions, workload, coverage and operational accountability."
      breadcrumbs={[{ label: 'HR' }, { label: "HR Staff Control" }]}
      actions={
        <>
      ...
      <main style={styles.page}>
        ...
        >
          <div>
            ...
            <h1 style={styles.title}>HR Staff Control</h1>
            <p style={styles.subtitle}>Department structure, staff capacity, ownership, permissions, workload, coverage and operational accountability.</p>
          </div>
