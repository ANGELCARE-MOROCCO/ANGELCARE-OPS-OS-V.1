...
const stats = [
    ["Active training", "21", "in progress"],
    ["Certified", "77", "valid"],
    ["Expired", "5", "blocked"],
    ["Due soon", "12", "renewal window"],
]

const heroActions = ["Assign Training", "Run Certification Scan", "Open Academy"]

const panels = [
    { icon: "🎓", title: "Training pathway", text: "Assign staff to onboarding, caregiver, sales, compliance or operations training.", actions: ['Assign course', 'Start onboarding', 'Track'] },
    { icon: "🛡️", title: "Certification control", text: "Track valid, expired and expiring certificates with renewal workflows.", actions: ['Renew', 'Request proof', 'Block'] },
    { icon: "🧠", title: "Skills matrix", text: "Map staff skills against department needs and mission requirements.", actions: ['Skill map', 'Gap report', 'Recommend'] },
]

const tableColumns = ["Program", "Audience", "Completion", "Risk", "Action"]

const tableRows = [
    ["Caregiver onboarding", "New staff", "62%", "Medium", "Push"],
    ["Compliance refresh", "All HR", "88%", "Low", "Review"],
    ["Sales protocol", "Sales", "41%", "High", "Escalate"],
]

export default function Page() {
  return (
    <AppShell
      title="Training & Certification Academy"
      subtitle="Training plans, certification tracking, readiness, academy alignment, skills matrix and expiry management."
      breadcrumbs={[{ label: 'HR' }, { label: "Training & Certification Academy" }]}
      actions={
        <>
    ...
    >
      <main style={styles.page}>
        ...
        >
          <div>
            <div style={styles.badge}>training / academy</div>
            <h1 style={styles.title}>Training & Certification Academy</h1>
            <p style={styles.subtitle}>Training plans, certification tracking, readiness, academy alignment, skills matrix and expiry management.</p>
          </div>
