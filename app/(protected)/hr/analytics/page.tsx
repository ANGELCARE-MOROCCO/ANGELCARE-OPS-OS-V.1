...
export default async function Page() {
  ...
  return <AppShell title="HR Analytics" subtitle="Monitor workforce health, recruitment throughput, attendance quality and onboarding readiness." breadcrumbs={[{label:'HR',href:'/hr'},{label:'HR Analytics'}]} actions={<><PageAction href="/hr" variant="light">HR Home</PageAction><PageAction href="/hr/command-center">Command Center</PageAction></>}>
    <HrV2Hero title="HR Analytics" subtitle="Monitor workforce health, recruitment throughput, attendance quality and onboarding readiness." actions={<><HrAction href="/hr/tasks">Create HR task</HrAction><HrAction href="/hr/analytics" variant="light">Analytics</HrAction></>} />
