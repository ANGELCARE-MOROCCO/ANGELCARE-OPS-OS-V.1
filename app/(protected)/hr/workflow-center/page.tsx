...
const stats = [
    ["Open tasks", "18", "ready for HR processing"],
    ["Critical", "4", "priority interventions"],
    ["Pending owners", "7", "need assignment"],
    ["Completed today", "12", "closed actions"],
]

const heroActions = ["Create HR Action", "Bulk Assign", "Export Queue"]

const panels = [
    { icon: "⚡", title: "Bulk execution console", text: "Select staff cases, assign owner, change status, escalate, archive or complete actions.", actions: ['Assign', 'Escalate', 'Complete', 'Archive'] },
    { icon: "🧭", title: "Priority routing", text: "Route actions to HR, management, operations, finance, academy or compliance.", actions: ['Route HR', 'Route Ops', 'Route Finance'] },
    { icon: "📌", title: "Follow-up control", text: "Create due dates, reminders, internal notes and proof-of-completion checks.", actions: ['Add note', 'Set due date', 'Request proof'] },
]

const tableColumns = ["Action", "Owner", "Priority", "Status", "Control"]

const tableRows = [
    ["Missing document follow-up", "HR Officer", "High", "Open", "Assign"],
    ["Attendance anomaly", "Ops Lead", "Medium", "Investigating", "Review"],
    ["Contract renewal", "Admin", "High", "Pending", "Escalate"],
]

export default function Page() {
  return (
    <AppShell
      title="HR Workflow Center"
      subtitle="Bulk actions, staff commands, alerts, escalation, assignment, completion, archive and operational follow-up control."
      breadcrumbs={[{ label: 'HR' }, { label: "HR Workflow Center" }]}
      actions={
        <>
    ...
    >
      <main style={styles.page}>
        ...
        >
          <div>
            <div style={styles.badge}>execution / bulk control</div>
            <h1 style={styles.title}>HR Workflow Center</h1>
            <p style={styles.subtitle}>Bulk actions, staff commands, alerts, escalation, assignment, completion, archive and operational follow-up control.</p>
          </div>
