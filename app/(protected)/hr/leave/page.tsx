...
const stats = [
    ["Pending leave", "9", "waiting HR"],
    ["Approved", "23", "this month"],
    ["Coverage gaps", "4", "need replacement"],
    ["Rejected", "2", "policy mismatch"],
]

const heroActions = ["New Leave Request", "Coverage Check", "Approve Queue"]

const panels = [
    { icon: "🌴", title: "Leave decision desk", text: "Approve leave while checking coverage, roster, replacements and policy.", actions: ['Approve', 'Reject', 'Request info'] },
    { icon: "🔁", title: "Replacement planning", text: "Find backup staff for approved absences and critical shifts.", actions: ['Find replacement', 'Assign backup', 'Notify'] },
    { icon: "📅", title: "Calendar impact", text: "Visualize leave volume by department, week and role.", actions: ['Month view', 'Department view', 'Risk view'] },
]

const tableColumns = ["Request", "Dates", "Coverage", "Status", "Action"]

const tableRows = [
    ["Annual leave", "May 14-16", "Covered", "Pending", "Approve"],
    ["Sick leave", "Today", "Gap", "Urgent", "Replace"],
    ["Emergency leave", "Tomorrow", "Review", "Submitted", "Escalate"],
]

export default function Page() {
  return (
    <AppShell
      title="Leave & Absence Command"
      subtitle="Leave requests, replacement coverage, approval impact, absence risk and calendar planning."
      breadcrumbs={[{ label: 'HR' }, { label: "Leave & Absence Command" }]}
      actions={
        <>
    ...
    >
      <main style={styles.page}>
        ...
        >
          <div>
            <div style={styles.badge}>leave / absence</div>
            <h1 style={styles.title}>Leave & Absence Command</h1>
            <p style={styles.subtitle}>Leave requests, replacement coverage, approval impact, absence risk and calendar planning.</p>
          </div>
