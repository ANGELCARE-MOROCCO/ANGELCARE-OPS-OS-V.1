...
const stats = [
    ["Ready", "64", "staff clear"],
    ["Exceptions", "11", "needs review"],
    ["Overtime", "18h", "pending approval"],
    ["Deductions", "5", "policy linked"],
]

const heroActions = ["Validate Payroll", "Export Finance File", "Lock HR Period"]

const panels = [
    { icon: "💰", title: "Payroll readiness", text: "Prepare HR data before finance payroll execution.", actions: ['Validate', 'Export', 'Lock period'] },
    { icon: "🧮", title: "Exception control", text: "Review late, absence, overtime, leave and adjustment cases.", actions: ['Review exception', 'Approve overtime', 'Adjust'] },
    { icon: "🔏", title: "Approval handoff", text: "Send validated HR payroll file to finance with audit trace.", actions: ['Send finance', 'Manager signoff', 'Archive'] },
]

const tableColumns = ["Staff", "Issue", "Amount/Time", "Status", "Action"]

const tableRows = [
    ["Hassan E.", "Overtime", "4h", "Pending", "Approve"],
    ["Imane R.", "Absence", "1 day", "Review", "Validate"],
    ["Team Sales", "Bonus", "Batch", "Draft", "Prepare"],
]

export default function Page() {
  return (
    <AppShell
      title="Payroll Preparation Control"
      subtitle="Payroll readiness, attendance exceptions, leave deductions, overtime, bonuses, claims and pre-payroll validation."
      breadcrumbs={[{ label: 'HR' }, { label: "Payroll Preparation Control" }]}
      actions={
        <>
    ...
    >
      <main style={styles.page}>
        ...
        >
          <div>
            <div style={styles.badge}>payroll / preparation</div>
            <h1 style={styles.title}>Payroll Preparation Control</h1>
            <p style={styles.subtitle}>Payroll readiness, attendance exceptions, leave deductions, overtime, bonuses, claims and pre-payroll validation.</p>
          </div>
