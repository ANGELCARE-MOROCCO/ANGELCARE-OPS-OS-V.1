...
export default function Page() {
  return (
    <AppShell
      title="HR Human Engine"
      subtitle="Performance reviews, KPI scoring, staff coaching, manager feedback, quality signals and improvement plans."
      breadcrumbs={[{ label: 'HR' }, { label: "HR Human Engine" }]}
      actions={
        <>
      ...
      <main style={styles.page}>
        ...
        >
          <div>
            ...
            <h1 style={styles.title}>HR Human Engine</h1>
            <p style={styles.subtitle}>Performance reviews, KPI scoring, staff coaching, manager feedback, quality signals and improvement plans.</p>
          </div>
