...
const stats = [
    ["Reviews due", "13", "this cycle"],
    ["Top score", "96%", "best performer"],
    ["Coaching", "6", "active plans"],
    ["Risk score", "3", "needs attention"],
]

const heroActions = ["Start Review", "Create Coaching Plan", "Export Scores"]

const panels = [
    { icon: "🏆", title: "Review workspace", text: "Score staff by KPIs, behavior, attendance, quality and execution.", actions: ['New review', 'Score', 'Approve'] },
    { icon: "📚", title: "Coaching plans", text: "Create improvement plans, follow-up dates and manager notes.", actions: ['Create plan', 'Assign coach', 'Check progress'] },
    { icon: "📉", title: "Risk detection", text: "Spot declining performance, repeated issues and quality warnings.", actions: ['Flag risk', 'Open case', 'Notify manager'] },
]

const tableColumns = ["Staff", "Score", "Signal", "Status", "Action"]

const tableRows = [
    ["Nadia L.", "92%", "Strong", "Reviewed", "Open"],
    ["Khalid B.", "61%", "Coaching", "Active", "Plan"],
    ["Meryem A.", "78%", "Stable", "Due", "Review"],
]

export default function Page() {
  return (
    <AppShell
      title="Staff 360 Control File"
      subtitle="Individual staff command file with profile, attendance, documents, training, performance, leave, incidents and actions."
      breadcrumbs={[{ label: 'HR' }, { label: "Staff 360 Control File" }]}
      actions={
        <>
    ...
    >
      <main style={styles.page}>
        ...
        >
          <div>
            <div style={styles.badge}>performance / reviews</div>
            <h1 style={styles.title}>Staff 360 Control File</h1>
            <p style={styles.subtitle}>Individual staff command file with profile, attendance, documents, training, performance, leave, incidents and actions.</p>
          </div>
