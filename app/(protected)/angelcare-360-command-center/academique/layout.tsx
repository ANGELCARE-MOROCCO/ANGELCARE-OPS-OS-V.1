...
export const metadata: Metadata = {
  title: `Académique · ${ANGELCARE360_PRODUCT_NAME}`,
  description: 'Moteur académique et d’évaluation ANGELCARE 360.',
}

export const dynamic = 'force-dynamic'

export default async function Angelcare360AcademiqueLayout({
  children,
}: {
  ...
  await requireAngelcare360Permission('academics.view', { context })
