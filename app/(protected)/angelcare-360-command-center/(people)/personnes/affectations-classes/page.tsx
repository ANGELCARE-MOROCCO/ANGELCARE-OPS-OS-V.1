...
import { getAngelcare360AccessContext, listAngelcare360Classes, listAngelcare360Students } from '@/lib/angelcare360/server'
import { listAngelcare360Sections } from '@/lib/angelcare360/server/administration'
import { listAngelcare360ClassEnrollments } from '@/lib/angelcare360/server/people'
import {
...
export default async function Angelcare360ClassAssignmentsPage() {
  ...
  const config = createClassEnrollmentPeopleConfig({
    ...
    classOptions: createClassOptions(classes as Array<Record<string, unknown>>),
    sectionOptions: createSectionOptions(sections as Array<Record<string, unknown>>),
  ...
  return (
    <Angelcare360PeopleHub
      config={config}
      rows={enrollments as Array<Record<string, unknown>>}
