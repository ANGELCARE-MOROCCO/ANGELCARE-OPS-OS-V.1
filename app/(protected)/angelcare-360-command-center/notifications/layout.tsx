...
export const metadata: Metadata = {
  title: `Notifications · ${ANGELCARE360_PRODUCT_NAME}`,
  description: 'Notifications internes ANGELCARE 360.',
}

export const dynamic = 'force-dynamic'

export default async function Angelcare360NotificationsLayout({ children }: { children: React.ReactNode }) {
