...
export default function Page() {
  ...
  return (
    <AppShell title="Enterprise Command" subtitle="Global command layer" breadcrumbs={[{ label: 'OPS OS', href: '/enterprise-command' }, { label: 'Enterprise Command' }]} actions={<PageAction href="/opsos-final-qa" variant="light">Final QA</PageAction>}>
      <GlobalShell>
        <GlobalNavStrip items={nav} />
        <GlobalHero
          eyebrow="AngelCare OPS OS Mega Pack V1"
          title="AngelCare Enterprise Command Center"
          subtitle="Unified premium control surface across Staff Portal, HR MAX, Market OS, Revenue Command and Academy."
          tone="blue"
          stats={[
        ...
        <GlobalPanel title="Global Module Command" subtitle="Open specialized command surfaces." tone="blue">
          {OPSOS_MODULES.map((m) => (
