  ...
  const checks: QualityCheck[] = [
    {
      ...
      count: trainees.filter((t: any) => !t.phone && !t.email).length,
      passed: trainees.every((t: any) => t.phone || t.email),
      impact: 'customer',
    ...
    },
    {
      ...
      count: courses.filter((c: any) => Number(c.price || 0) <= 0 || Number(c.duration_hours || 0) <= 0).length,
      passed: courses.every((c: any) => Number(c.price || 0) > 0 && Number(c.duration_hours || 0) > 0),
      impact: 'financial',
    ...
    },
    {
      ...
      count: trainers.filter((t: any) => !t.specialty).length,
      passed: trainers.every((t: any) => !!t.specialty),
      impact: 'operational',
    ...
    },
    {
      ...
      count: groups.filter((g: any) => Number(g.max_capacity || 0) <= 0).length,
      passed: groups.every((g: any) => Number(g.max_capacity || 0) > 0),
      impact: 'operational',
    ...
    },
    {
      ...
      count: payments.filter((p: any) => p.status === 'paid' && !p.reference).length,
      passed: payments.every((p: any) => p.status !== 'paid' || !!p.reference),
      impact: 'compliance',
