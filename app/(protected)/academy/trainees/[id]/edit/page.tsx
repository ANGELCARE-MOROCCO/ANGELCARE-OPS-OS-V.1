...
export default async function Page({ params, searchParams }: PageProps) {
  ...
  const m = meta(t)
  const paid = payments.reduce((s, p) => s + number(p.amount || p.amount_mad || p.paid_amount), 0)
