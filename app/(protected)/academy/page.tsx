...
export default async function AcademyCommandCenterPage() {
  ...
  return <AppShell title="AngelCare Academy Command Center" subtitle="Centralized premium training, certification, trainee lifecycle, partner dispatch and post-graduation integration." breadcrumbs={[{ label: 'Academy' }]} actions={<><PageAction href="/academy/certificates" variant="light">Certificates</PageAction><PageAction href="/academy/enrollments">New enrollment</PageAction></>}><div style={pageStyle}><section style={heroStyle}><div style={badgeStyle}>ACADEMY OS • CERTIFICATION • DUTY READINESS • PARTNER DISPATCH</div><h1 style={heroTitleStyle}>Premium Multilayer Training Center</h1><p style={heroTextStyle}>From candidate intake to certified AngelCare deployment, the Academy hub controls enrollment, eligibility, payments, groups, trainers, courses, attendance, permanent serial trainee folders, certificate authenticity, graduation, partners, alerts, sales and after-sales.</p></section><section style={kpiGridStyle}><Kpi title="Active cohorts" value="12" sub="classroom / hybrid / B2B" tone="#7c3aed"/><Kpi title="Trainees in pipeline" value="148" sub="lead to certification" tone="#2563eb"/><Kpi title="Certificates ready" value="32" sub="serial authenticity" tone="#16a34a"/><Kpi title="Payment attention" value="18" sub="pending or partial" tone="#ea580c"/><Kpi title="Partner dispatch" value="9" sub="schools & pro partners" tone="#db2777"/></section><Section title="Academy lifecycle engine" subtitle="Operational pathway used by managers to move candidates into certified deployable profiles."><Pipeline /></Section><Section title="14 Academy submodules" subtitle="Every card opens a dedicated operational workspace with its own logic, controls and management angle."><ModuleNav /></Section><section style={grid3Style}><OperationalCard title="Authenticity & compliance" detail="Each trainee profile is designed around a unique permanent serial number reused during certificate generation, verification and audit trail." tag="ISO-ready" tone="#16a34a"/><OperationalCard title="Placement-ready training" detail="Graduated trainees can be integrated into AngelCare duties, assigned to schools, connected to partners or targeted for premium upsell." tag="Deployment" tone="#2563eb"/><OperationalCard title="Commercial continuity" detail="Sales and after-sales are not isolated; reminders, follow-ups, renewal offers and partner opportunities remain attached to the Academy journey." tag="Revenue" tone="#db2777"/></section></div></AppShell>
}
