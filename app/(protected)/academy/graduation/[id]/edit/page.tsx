...
export default async function AcademyDetailPage({ params }: { params: { id: string } }) {
 ...
 const path = '/academy/graduation/' + params.id + '/edit'
 return <AppShell title="Graduation Follow-up Edit & Execute" subtitle="Deep Academy execution workspace" breadcrumbs={[{label:'Academy',href:'/academy'},{label:'Graduation Follow-ups',href:'/academy/graduation'},{label:String(title)}]} actions={<PageAction href="/academy/graduation">Back</PageAction>}>
 <div style={page}>
