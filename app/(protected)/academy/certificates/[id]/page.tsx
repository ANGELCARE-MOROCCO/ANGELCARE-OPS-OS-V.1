...
export default async function AcademyDetailPage({ params }: { params: { id: string } }) {
 ...
 const path = '/academy/certificates/' + params.id
 return <AppShell title="Certificate Command Folder" subtitle="Deep Academy execution workspace" breadcrumbs={[{label:'Academy',href:'/academy'},{label:'Certificates',href:'/academy/certificates'},{label:String(title)}]} actions={<PageAction href="/academy/certificates">Back</PageAction>}>
 <div style={page}>
