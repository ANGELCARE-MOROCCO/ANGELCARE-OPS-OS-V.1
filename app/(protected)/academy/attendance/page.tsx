...
export default async function AcademySubmodulePage() {
  ...
  return <AppShell title="Academy • Attendance Management" subtitle="Daily presence, lateness, absence, completion and readiness signals." breadcrumbs={[{ label: 'Academy', href: '/academy' }, { label: 'Attendance Management' }]} actions={<><PageAction href="/academy" variant="light">Academy Hub</PageAction><PageAction href="/academy/certificates">Certificates</PageAction></>}><div style={pageStyle}><section style={heroStyle}><div style={badgeStyle}>ACADEMY SUBMODULE • ATTENDANCE</div><h1 style={heroTitleStyle}>Attendance Management</h1><p style={heroTextStyle}>Daily presence, lateness, absence, completion and readiness signals. This workspace is structured for high-control training operations, documentation quality, ISO-style traceability and future database activation.</p></section><section style={kpiGridStyle}><Kpi title="Operational readiness" value="92%" sub="process configured" tone="#7c3aed"/><Kpi title="Records controlled" value="Active" sub="traceability mode" tone="#2563eb"/><Kpi title="Alerts" value="3" sub="manager attention" tone="#ea580c"/><Kpi title="Quality level" value="Premium" sub="AngelCare standard" tone="#16a34a"/><Kpi title="Integration" value="Ready" sub="OpsOS connected" tone="#db2777"/></section><Section title="Submodule command functions" subtitle="Dedicated controls for this Academy domain."><div style={grid3Style}><OperationalCard title="Live attendance" detail="Manage live attendance with structured status, ownership, documentation, alerts and action history." tag="Control" tone="#7c3aed" /><OperationalCard title="Absence justification" detail="Manage absence justification with structured status, ownership, documentation, alerts and action history." tag="Control" tone="#7c3aed" /><OperationalCard title="Late arrival tracking" detail="Manage late arrival tracking with structured status, ownership, documentation, alerts and action history." tag="Control" tone="#7c3aed" /><OperationalCard title="Session completion" detail="Manage session completion with structured status, ownership, documentation, alerts and action history." tag="Control" tone="#7c3aed" /><OperationalCard title="Attendance risk" detail="Manage attendance risk with structured status, ownership, documentation, alerts and action history." tag="Control" tone="#7c3aed" /><OperationalCard title="Export attendance" detail="Manage export attendance with structured status, ownership, documentation, alerts and action history." tag="Control" tone="#7c3aed" /></div></Section><Section title="Related Academy navigation" subtitle="Return to hub or move laterally across Academy operations."><ModuleNav current="attendance" /></Section><section style={grid2Style}><OperationalCard title="Smart manager diagnosis" detail="This area should surface missing data, risk, delay, conversion blockers and next best action for Academy managers." tag="AI-ready" tone="#2563eb"/><OperationalCard title="Compliance documentation" detail="Every action is designed to be connected later to logs, certificates, trainee folders and audit-ready documentation." tag="ISO" tone="#16a34a"/></section></div></AppShell>
}
