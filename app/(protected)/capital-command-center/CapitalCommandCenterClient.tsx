...
type EntityKey = 'investors' | 'opportunities' | 'commitments' | 'payments' | 'diligence' | 'documents' | 'notes'
type ViewKey = 'command' | 'investors' | 'fundraising' | 'deals' | 'diligence' | 'commitments' | 'payments' | 'dataroom' | 'reports'
...
const EMPTY_STATE: AnyRecord = {
  investors: [], opportunities: [], commitments: [], payments: [], diligence: [], documents: [], notes: [],
...
export default function CapitalCommandCenterClient() {
  ...
  const globalContext = { investors, opportunities, commitments, payments, diligence, documents, notes, open, archive, setDetail }
