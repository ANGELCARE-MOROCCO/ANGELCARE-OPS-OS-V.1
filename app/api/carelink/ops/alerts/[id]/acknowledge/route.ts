import { acknowledgeOpsAlert } from '@/lib/carelink/ops-enterprise'
...
export async function POST(request: Request, context: Context) {
  try {
    ...
    const alert = await acknowledgeOpsAlert(
      id,
    ...
    return opsError(error, 'Impossible d’accuser réception de l’alerte Ops')
  }
}
