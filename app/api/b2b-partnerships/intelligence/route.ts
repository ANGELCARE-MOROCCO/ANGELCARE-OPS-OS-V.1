  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        risks: [],
        recommendations: [
          'Créer une liste de prospects hôtels premium.',
          'Sélectionner 3 templates de premier contact.',
    ...
    console.error('[B2B_INTELLIGENCE_GET_CRASHED]', error)
    return NextResponse.json({ ok: true, data: { risks: [], recommendations: [] } })
  }
}
