...
console.log('AC CAPITAL OS MZ6 installer');
...
console.log('\nAC CAPITAL OS Mega ZIP 6 files copied successfully.');
...
console.log('MZ1 Foundation, MZ2 Cockpit, MZ3 Radar, MZ4 Qualification and MZ5 Funder payload files are preserved in this integrated package.');
console.log('Next: node ./AC_CAPITAL_OS_MZ6/scripts/verify_ac_capital_os_mz6.mjs');
