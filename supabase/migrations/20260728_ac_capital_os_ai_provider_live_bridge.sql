...
values
  ('ac_capital_os','ai-command-center','AC_CAPITAL_GOVERNED_RUN','ai_recommended',true,false,2,
   100,500,1800,120000,4096,1,5,20,1,'short',900,15,true,'executive',
...
on conflict (module_key,workspace_key,command_code) do update set
  ...
  max_cost_usd_per_day=5,max_cost_usd_per_week=20,max_retries=1,cache_mode='short',cache_ttl_seconds=900,
  duplicate_window_seconds=15,force_refresh_allowed=true,approval_class='executive',
