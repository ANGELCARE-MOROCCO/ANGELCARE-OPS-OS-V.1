...
select 'ac_capital_os', x.workspace_key, x.command_code, 'ai_required', true, false, 5,
       ...
       2, 10, 40, 1, 'no_cache', 0, 5, true, 'executive',
...
on conflict (module_key,workspace_key,command_code) do update set
  ...
  max_cost_usd_per_day=10, max_cost_usd_per_week=40, max_retries=1, cache_mode='no_cache', cache_ttl_seconds=0,
  duplicate_window_seconds=5, force_refresh_allowed=true, approval_class='executive',
