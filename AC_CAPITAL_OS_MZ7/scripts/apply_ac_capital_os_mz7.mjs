...
console.log('AC CAPITAL OS MZ7 installer');
...
console.log('\nAC CAPITAL OS Mega ZIP 7 files copied successfully.');
...
console.log('MZ1 Foundation, MZ2 Cockpit, MZ3 Radar, MZ4 Qualification, MZ5 Funder and MZ6 Doctrine payload files are preserved in this integrated package.');
console.log('Next: node ./AC_CAPITAL_OS_MZ7/scripts/verify_ac_capital_os_mz7.mjs');
