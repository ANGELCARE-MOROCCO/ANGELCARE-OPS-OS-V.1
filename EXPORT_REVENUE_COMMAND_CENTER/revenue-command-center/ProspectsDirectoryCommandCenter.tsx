...
export default function ProspectsDirectoryCommandCenter() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#050b16] text-white">
      ...
      <main className="relative mx-auto flex w-full max-w-[1920px] items-start gap-4 px-4 py-4">

        <aside className="sticky top-4 flex h-[calc(100vh-32px)] w-[270px] min-w-[270px] shrink-0 flex-col rounded-[24px] border border-[#244365] bg-[#07111f]/95 px-5 py-6 shadow-[16px_0_60px_rgba(0,0,0,.35)] backdrop-blur-xl">
...
function AddProspectModal({ city, onClose, onSubmit }: { city: string; onClose: () => void; onSubmit: (payload: Partial<ProspectRecord>) => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/75 p-4 backdrop-blur-md">
      <div className="max-h-[92vh] w-full max-w-6xl overflow-y-auto rounded-[32px] border border-[#315474] bg-[#081525] shadow-[0_30px_90px_rgba(0,0,0,.65)]">
