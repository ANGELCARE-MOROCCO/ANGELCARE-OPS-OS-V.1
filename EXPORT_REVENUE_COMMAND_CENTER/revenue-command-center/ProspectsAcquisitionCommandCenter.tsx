...
export default function ProspectsAcquisitionCommandCenter() {
  ...
  const activeStageTotal = stageStats.reduce((sum, s) => sum + s.count, 0) || 1
  ...
  return (
    <div data-prospect-command-center="true" className="min-h-screen overflow-x-hidden bg-[#050b16] text-white">
      ...
      <div className="prospect-shell relative mx-auto flex w-full max-w-[1920px] gap-4 px-4 py-3">
        ...
        <main className="min-w-0 flex-1 px-0 py-0 lg:px-0 2xl:px-0">
...
function NavGroup({ title, children }: { title: string; children: React.ReactNode }) {
  return <div className="mb-5"><div className="mb-2 text-[11px] font-bold uppercase tracking-[.16em] text-white">{title}</div><div className="space-y-1">{children}</div></div>
}
