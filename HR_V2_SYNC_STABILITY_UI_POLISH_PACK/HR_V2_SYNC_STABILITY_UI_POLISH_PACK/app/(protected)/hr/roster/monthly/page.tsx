...
export default function Page() {
  return (
    <HrV2CommandWorkspace
      title='Monthly Roster Command Calendar'
      subtitle='Monthly duty and shift control view for all staff with filters, gap visibility, and direct assignment actions.'
      module='Monthly Roster'
      kpis={[
