...
export default function Page() {
  return (
    <HrV2CommandWorkspace
      title='HR Workforce Command Center'
      subtitle='Premium manual HR execution cockpit with stronger hierarchy, page actions, sync visibility, and stabilized operating widgets.'
      module='Overview'
      kpis={[
