...
console.log('AC CAPITAL OS MZ3 installer');
...
console.log('\nAC CAPITAL OS Mega ZIP 3 files copied successfully.');
...
console.log('Next: node ./AC_CAPITAL_OS_MZ3/scripts/verify_ac_capital_os_mz3.mjs');
