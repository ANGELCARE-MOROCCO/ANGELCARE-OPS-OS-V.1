  ...
  properties: {
    ...
    opportunities: {
      ...
      items: {
        type: "object",
        properties: {
          title: { type: "string" }, opportunityType: { type: "string" }, country: { type: ["string", "null"] }, region: { type: ["string", "null"] },
          amountMin: { type: ["number", "null"] }, amountMax: { type: ["number", "null"] }, amountRangeLabel: { type: ["string", "null"] },
          currencyLabel: { type: "string" }, deadline: { type: ["string", "null"] }, deadlineLabel: { type: ["string", "null"] }, deadlineHeat: { type: "string" },
          sourceTitle: { type: "string" }, sourceUrl: { type: "string" }, eligibilityPreview: { type: "string" }, angelcareRelevancePreview: { type: "string" },
          whyCaptured: { type: "string" }, sourceConfidence: { type: "number" }, relevanceScore: { type: "number" }, captureDecision: { type: "string" }, rejectionReason: { type: ["string", "null"] },
        },
        required: ["title", "opportunityType", "country", "region", "amountMin", "amountMax", "amountRangeLabel", "currencyLabel", "deadline", "deadlineLabel", "deadlineHeat", "sourceTitle", "sourceUrl", "eligibilityPreview", "angelcareRelevancePreview", "whyCaptured", "sourceConfidence", "relevanceScore", "captureDecision", "rejectionReason"],
        additionalProperties: false,
      },
    },
    rejectedSignals: { type: "array", items: { type: "object", properties: { title: { type: "string" }, reason: { type: "string" }, sourceTitle: { type: ["string", "null"] }, sourceUrl: { type: ["string", "null"] } }, required: ["title", "reason", "sourceTitle", "sourceUrl"], additionalProperties: false } },
...
function normalizeOpportunity(raw: unknown, sourceByUrl: Map<string, ExternalResearchSource>): ExternalResearchOpportunity | null {
  ...
  return {
    ...
    sourceTitle: clean(row.sourceTitle || sourceByUrl.get(url)?.title),
    sourceUrl: url,
    ...
    sourceConfidence: Math.max(0, Math.min(100, number(row.sourceConfidence, 60))),
