...
console.log('AC CAPITAL OS MZ8 installer');
...
console.log('\nAC CAPITAL OS Mega ZIP 8 files copied successfully.');
...
console.log('Data Room API installed at: apps/ops-web/app/api/ac-capital-os/data-room/route.ts');
console.log('MZ1 through MZ7 payload files are preserved in this integrated package.');
console.log('Next: node ./AC_CAPITAL_OS_MZ8/scripts/verify_ac_capital_os_mz8.mjs');
