...
export type AcCapitalCasePackageType =
  | 'Bank Package'
  | 'VC Package'
  | 'Grant Package'
  | 'Impact Package'
...
export type AcCapitalCaseStatus =
...
export type AcCapitalCaseStageStatus =
  | 'Not Started'
  | 'AI Draft Ready'
  | 'Needs Data'
...
export type AcCapitalCaseDocumentStatus =
  | 'Ready'
  | 'Needs Update'
  | 'Missing'
  | 'Not Required'
  | 'Needs Founder Approval'
  | 'Needs Signature/Stamp'
  | 'Needs External Supplier'
  | 'Needs Data Room Upload'
  | 'Later ZIP/Data Room Required';
