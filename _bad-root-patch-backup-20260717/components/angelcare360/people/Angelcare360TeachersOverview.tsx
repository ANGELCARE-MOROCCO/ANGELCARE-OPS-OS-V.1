      ...
      <section style={heroStyle}>
        <div style={heroTextStyle}>
          ...
          <div style={contextLineStyle}>
            ...
            <span style={contextPillStyle}>{activeRows.length ? `${activeRows.length} enseignant(s) actif(s)` : 'Aucun enseignant actif'}</span>
            {assignmentReadyCount < activeRows.length ? <span style={softQualityPillStyle}>Affectations à compléter</span> : null}
          </div>
        </div>
