...
export default function Page() {
  return (
    <OperationalControlShell active="audit">
      <div className="grid gap-6 lg:grid-cols-[1.5fr_0.8fr]">
        <section>
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <h2 className="mt-3 text-3xl font-black text-slate-950">Audit and traceability center</h2>
          ...
          <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <h3 className="mt-2 text-lg font-black text-slate-950">Profile update</h3>
          ...
          <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-slate-400">Control item</p>
                <h3 className="mt-2 text-lg font-black text-slate-950">Roster change</h3>
                <p className="mt-2 text-sm leading-6 text-slate-600">Open the record, add notes, assign owner, set priority, and move the item through the manual HR control workflow.</p>
              </div>
              <span className="rounded-full bg-amber-100 px-3 py-1 text-xs font-black text-amber-700">Review</span>
            </div>
          ...
          <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-slate-400">Control item</p>
                <h3 className="mt-2 text-lg font-black text-slate-950">Leave approval</h3>
                <p className="mt-2 text-sm leading-6 text-slate-600">Open the record, add notes, assign owner, set priority, and move the item through the manual HR control workflow.</p>
              </div>
              <span className="rounded-full bg-amber-100 px-3 py-1 text-xs font-black text-amber-700">Review</span>
            </div>
          ...
          <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-slate-400">Control item</p>
                <h3 className="mt-2 text-lg font-black text-slate-950">Document verification</h3>
                <p className="mt-2 text-sm leading-6 text-slate-600">Open the record, add notes, assign owner, set priority, and move the item through the manual HR control workflow.</p>
              </div>
              <span className="rounded-full bg-amber-100 px-3 py-1 text-xs font-black text-amber-700">Review</span>
            </div>
